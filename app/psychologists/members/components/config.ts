// ============================================
// COURSE CONFIGURATION - PSYCHOLOGISTS
// ============================================
...
export const COURSE_MODULES = [
  ...
  },
  {
    ...
    resources: [
      { name: 'Psychologist AI Talking Video Prompt', url: '/products/psychologist/Therapist_AI_Video_Prompt.txt', type: 'file' as const },
    ],
  },
  {
    id: 'module-4',
    ...
    resources: [
      { name: 'Background Music Collection', url: '/products/psychologist/Background music/', type: 'folder' as const },
    ],
  },
  {
    id: 'module-5',
    ...
    resources: [
      { name: 'Psychologist AI Image Generation Prompt', url: '/products/psychologist/Therapist_AI_Image_Prompt.txt', type: 'file' as const },
    ],
  },
  {
    id: 'module-6',
