...
export const DashboardSection = memo(function DashboardSection({ state }: DashboardProps) {
  ...
  return (
    <div className="space-y-4 sm:space-y-8 animate-fade-in">
      ...
      <div className="sm:hidden relative overflow-hidden rounded-3xl bg-gradient-premium p-5 border border-purple-500/20 noise-overlay section-premium">
        {/* Floating Gradient Orbs - LP Style */}
        <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-purple-500/20 to-violet-500/10 rounded-full blur-3xl floating" />
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-br from-violet-500/15 to-purple-500/5 rounded-full blur-3xl floating-slow" style={{ animationDelay: '2s' }} />

        <div className="relative z-10">
          {/* Greeting */}
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-purple-400 text-xs font-bold uppercase tracking-wider mb-1">Welcome back</p>
              <h1 className="text-2xl font-black text-white drop-shadow-lg">
                {state.studentName || 'Student'}
              </h1>
            </div>
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500 to-violet-500 flex items-center justify-center shadow-glow-purple">
          ...
          <div className="mb-4">
            <div className="flex justify-between text-xs mb-2">
              ...
              <span className="text-purple-400 font-bold">{state.timeRemaining} min left</span>
            </div>
          ...
          <button
            ...
            className="btn-premium w-full py-4 rounded-2xl text-white font-bold text-base flex items-center justify-center gap-2 shadow-glow-purple animate-pulse-glow"
          >
      ...
      <div className="hidden sm:block relative overflow-hidden rounded-3xl bg-gradient-hero p-8 text-white section-premium noise-overlay border border-purple-500/20">
        {/* Floating Gradient Orbs */}
        <div className="absolute top-0 right-0 w-80 h-80 bg-gradient-to-br from-purple-500/15 to-violet-500/5 rounded-full blur-3xl floating-slow" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-br from-violet-500/10 to-purple-500/5 rounded-full blur-3xl floating" style={{ animationDelay: '2s' }} />
        <div className="relative z-10">
          ...
          <div className="bg-black/30 backdrop-blur-sm rounded-full h-4 mb-2 overflow-hidden border border-purple-500/20">
            <div className="h-full bg-gradient-to-r from-purple-500 to-violet-400 rounded-full transition-all duration-500" style={{ width: `${state.progressPercent}%` }} />
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-slate-300">{state.completedCount}/{state.totalModules} modules</span>
            <span className="font-bold text-purple-400">{Math.round(state.progressPercent)}%</span>
          </div>
        </div>
      </div>
      ...
      <div className="sm:hidden grid grid-cols-2 gap-3">
        {[
          { icon: Clock, label: 'Watch Time', value: `${state.totalWatchTimeMinutes}m`, color: 'from-purple-500 to-violet-500', iconColor: '#14b8a6' },
          ...
          { icon: Trophy, label: 'Badges', value: `${state.unlockedCount}/${ACHIEVEMENTS.length}`, color: 'from-emerald-500 to-purple-500', iconColor: '#10b981' },
        ].map((stat, i) => (
          <div key={i} className="relative overflow-hidden rounded-2xl glass-purple p-4 hover-lift">
      ...
      <div className="hidden sm:grid grid-cols-3 lg:grid-cols-5 gap-4">
        <div className="glass-premium rounded-2xl p-6 hover-lift col-span-1 border border-purple-500/20">
        ...
        {[
          { icon: Clock, label: 'Watched', value: `${state.totalWatchTimeMinutes}m`, color: 'from-purple-500 to-violet-500' },
          ...
          { icon: Trophy, label: 'Badges', value: `${state.unlockedCount}/${ACHIEVEMENTS.length}`, color: 'from-emerald-500 to-purple-500' },
        ].map((stat, i) => (
          <div key={i} className="glass-premium rounded-2xl p-6 hover-lift border border-purple-500/10">
            <div className="flex items-center gap-4">
      ...
      {state.progressPercent < 100 && (
        <div className="sm:hidden">
          <h3 className="text-sm font-bold text-purple-400 uppercase tracking-wider mb-3 px-1">Up Next</h3>
          <button
            onClick={() => {
              state.setCurrentModuleIndex(state.nextIncompleteModuleIndex)
              state.setActiveSection('course')
            }}
            className="w-full relative overflow-hidden rounded-2xl glass-purple p-4 text-left active:scale-[0.99] transition-transform hover-lift"
          >
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-500 to-violet-500 flex items-center justify-center shadow-glow-purple flex-shrink-0">
      ...
      {showWelcomeVideo && (
        <div className="glass-premium rounded-3xl shadow-2xl border border-purple-500/20 overflow-hidden">
      ...
      <div className="sm:hidden">
        <h3 className="text-sm font-bold text-purple-400 uppercase tracking-wider mb-3 px-1">Quick Actions</h3>
        <div className="flex gap-3">
          {[
            { icon: Gift, label: 'Bonuses', color: 'from-violet-500 to-blue-500', section: 'bonuses' as const },
            { icon: Trophy, label: 'Badges', color: 'from-amber-500 to-orange-500', section: 'achievements' as const },
            { icon: MessageCircle, label: 'Support', color: 'from-emerald-500 to-purple-500', section: null },
          ].map((item, i) => (
            item.section ? (
              <button
                key={i}
                onClick={() => state.setActiveSection(item.section)}
                className="flex-1 relative overflow-hidden rounded-2xl glass-purple p-4 text-center active:scale-95 transition-transform hover-lift"
              >
      ...
      <div className="hidden sm:grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 glass-premium rounded-2xl p-6 border border-purple-500/20">
          <h2 className="text-xl font-black text-white mb-4">
            {state.progressPercent >= 100 ? 'Course Complete!' : 'Continue Learning'}
          </h2>
          {state.progressPercent >= 100 ? (
            <div className="text-center py-6">
              <div className="w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br from-emerald-400 to-purple-500 flex items-center justify-center shadow-glow-purple mb-4">
              ...
              <button
                ...
                className="btn-premium inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-white shadow-glow-purple"
              >
            ...
            <button
              className="w-full flex items-center gap-4 p-4 rounded-xl glass-purple hover-lift text-left"
              onClick={() => {
                state.setCurrentModuleIndex(state.nextIncompleteModuleIndex)
                state.setActiveSection('course')
              }}
            >
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-purple-500 to-violet-500 flex items-center justify-center shadow-glow-purple relative flex-shrink-0">
        ...
        <div className="glass-premium rounded-2xl p-6 border border-purple-500/20">
          <h2 className="text-xl font-black text-white mb-4">Quick Actions</h2>
          <div className="space-y-3">
            <button
              onClick={() => state.setActiveSection('bonuses')}
              className="w-full flex items-center gap-3 p-4 rounded-xl glass-purple hover:border-violet-400/50 transition-all hover-lift"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-4 rounded-xl glass-purple hover:border-amber-400/50 transition-all hover-lift"
            >
            ...
            <a
              href={`mailto:${COURSE_CONFIG.supportEmail}`}
              className="w-full flex items-center gap-3 p-4 rounded-xl glass-purple hover:border-emerald-400/50 transition-all hover-lift"
            >
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-purple-500 flex items-center justify-center shadow-lg">
      ...
      <div className="sm:hidden rounded-2xl glass-premium p-4 border border-purple-500/20">
        <div className="grid grid-cols-4 gap-2 text-center">
          {[
            { icon: Users, value: `${(memberStats.totalMembers / 1000).toFixed(1)}k`, label: 'Students', color: 'text-purple-400' },
      ...
      <div className="hidden sm:block glass-premium rounded-2xl p-5 border border-purple-500/20">
        <div className="grid grid-cols-4 gap-4 text-center">
          <div className="flex flex-row items-center justify-center gap-2 p-2 rounded-lg glass-purple">
      ...
      <div className="hidden sm:block relative overflow-hidden rounded-2xl bg-gradient-hero p-8 section-premium noise-overlay border border-purple-500/20">
        {/* Floating Gradient Orbs */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-purple-500/10 to-violet-500/5 rounded-full blur-3xl floating-slow" />
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-br from-violet-500/10 to-purple-500/5 rounded-full blur-3xl floating" style={{ animationDelay: '2s' }} />
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full glass-purple border border-amber-500/30">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {COMING_SOON_COURSES.map((course) => {
              ...
              return (
                <div key={course.id} className="relative group glass-premium rounded-xl p-5 border border-purple-500/20 hover:border-purple-400/40 transition-all duration-300 hover-lift">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {course.features.slice(0, 2).map((feature, i) => (
                      <span key={i} className="px-2 py-1 rounded-md glass-purple text-slate-300 text-xs">{feature}</span>
                    ))}
                    {course.features.length > 2 && (
                      <span className="px-2 py-1 rounded-md glass-purple text-slate-400 text-xs">+{course.features.length - 2} more</span>
                    )}
                  </div>
                  <div className="flex items-center justify-between text-sm mb-4">
                    <span className="text-slate-400"><span className="text-purple-400 font-bold">{course.waitlistCount.toLocaleString()}</span> waiting</span>
                  ...
                  <button
                    ...
                    className={`w-full py-3 rounded-xl font-bold text-sm transition-all duration-300 flex items-center justify-center gap-2 ${
                      isWaitlisted
                        ? 'glass-purple text-purple-400 border border-purple-500/30'
                        : 'btn-premium text-white shadow-glow-purple'
                    }`}
                  >
    ...
    <div {...swipeHandlers} className="space-y-4 sm:space-y-6 animate-fade-in touch-pan-y">
      ...
      <div className="sm:hidden flex items-center justify-between">
        ...
        <div className="text-center">
          <p className="text-xs text-purple-400 font-bold">Module {currentModule.number}</p>
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className={`p-2 rounded-xl transition-all ${isBookmarked ? 'text-purple-400 glass-purple' : 'text-slate-400'}`}
          >
      ...
      <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl shadow-purple-500/10 glass-premium border border-purple-500/20">
        {!currentModule.comingSoon && currentModule.wistiaId ? (
          ...
          <div className="aspect-video bg-gradient-hero flex items-center justify-center">
            <div className="text-center">
              <div className="w-16 h-16 rounded-2xl glass-premium flex items-center justify-center mx-auto mb-4 border border-purple-500/20">
      ...
      <div className="sm:hidden glass-premium rounded-2xl p-4 border border-purple-500/20">
        {/* Module badges */}
        <div className="flex flex-wrap items-center gap-2 mb-3">
          <span className="px-3 py-1 rounded-full text-xs font-bold bg-gradient-to-r from-purple-500 to-violet-500 text-white shadow-lg">
            Module {currentModule.number}
          </span>
          <span className="px-3 py-1 rounded-full text-xs font-medium glass-purple text-slate-300">
        ...
        <div className="flex items-center gap-3">
          {!currentModule.comingSoon && (
            <button
              ...
              className={`flex-1 py-3.5 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 ${
                isCompleted
                  ? 'glass-purple text-emerald-400 border border-emerald-500/30'
                  : 'btn-premium text-white shadow-glow-purple active:scale-[0.98]'
              }`}
            >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={!canGoPrev}
              className={`p-3 rounded-xl transition-all ${canGoPrev ? 'glass-purple text-slate-300 active:scale-95' : 'opacity-40 glass-dark'}`}
            >
              <ChevronLeft className="w-5 h-5" />
            </button>
            <button
              ...
              disabled={!canGoNext}
              className={`p-3 rounded-xl transition-all ${canGoNext ? 'btn-premium text-white shadow-glow-purple active:scale-95' : 'opacity-40 glass-dark'}`}
            >
      ...
      <div className="hidden sm:grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4">
              ...
              <button
                ...
                className={`ml-auto p-2 rounded-lg transition-all ${
                  isBookmarked
                    ? 'glass-purple text-purple-400'
                    : 'glass-dark text-slate-400 hover:text-purple-400'
                }`}
              >
                {isBookmarked ? <BookmarkCheck className="w-5 h-5" /> : <Bookmark className="w-5 h-5" />}
              </button>
            ...
            <div className="flex items-center justify-between mt-6 pt-4 border-t border-white/10">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-xl font-bold text-white transition-all ${
                  canGoNext ? 'btn-premium shadow-glow-purple' : 'opacity-40 glass-dark'
                }`}
              >
          ...
          <div className="glass-premium rounded-2xl p-6 border border-purple-500/20">
            ...
            <div className="space-y-3">
              {currentModule.lessons.map((lesson, i) => (
                <div key={i} className="flex items-center gap-3 p-3 rounded-xl glass-purple">
          ...
          {currentModule.resources.length > 0 && (
            <div className="glass-premium rounded-2xl p-6 border border-purple-500/20">
              <h3 className="font-bold text-white mb-4 flex items-center gap-2">
                <Download className="w-5 h-5 text-purple-400" /> Resources
              </h3>
              <div className="space-y-3">
                {currentModule.resources.map((resource, i) => (
                  <a
                    ...
                    className="flex items-center gap-4 p-4 rounded-xl glass-purple hover:border-purple-400/50 transition-all hover-lift"
                  >
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-violet-500 flex items-center justify-center flex-shrink-0 shadow-lg">
        ...
        <div className="space-y-4">
          <div className="glass-premium rounded-2xl p-5 border border-purple-500/20">
            <div className="flex items-center justify-between mb-4">
                    ...
                    <div className={`relative ${
                      isCurrent
                        ...
                        : moduleCompleted
                          ...
                          : 'glass-dark border border-transparent hover:border-purple-500/20'
                    }`}>
                      ...
                      <div className={`relative aspect-video bg-gradient-to-br ${gradientClass} overflow-hidden`}>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${
                            ...
                            {moduleCompleted ? (
                              ...
                              <Play className={`w-5 h-5 ${isCurrent ? 'text-purple-500' : 'text-slate-600'}`} fill={isCurrent ? '#14b8a6' : '#475569'} />
                            )}
                          </div>
                        </div>
                        ...
                        {isCurrent && !moduleCompleted && (
                          <div className="absolute top-2 left-2 px-1.5 py-0.5 rounded bg-purple-500 text-[10px] font-bold text-white animate-pulse">
                            Playing
                          </div>
                        )}
                      </div>
                ...
                <div className={`relative overflow-hidden rounded-2xl border transition-all duration-300 ${
                  isComingSoon
                    ...
                    : moduleCompleted
                      ...
                      : 'glass-dark border-slate-700/50 hover:border-purple-500/30'
                }`}>
                      ...
                      {module.lessons.slice(0, 2).map((lesson, i) => (
                        <div key={i} className="flex items-center gap-2">
                          <div className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${
                            moduleCompleted ? 'bg-emerald-400' : 'bg-purple-400'
                          }`} />
    ...
    <div className="space-y-4 sm:space-y-6 animate-fade-in">
      ...
      <div className="sm:hidden">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="px-3 py-1.5 rounded-full bg-gradient-to-r from-purple-500 to-violet-500 text-white text-xs font-bold shadow-glow-purple">
      ...
      <div className="hidden sm:flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black text-white flex items-center gap-3">
            <Gift className="w-8 h-8 text-purple-400" /> Bonus Resources
          </h1>
          <p className="text-slate-400 mt-1">Resources worth <span className="font-bold text-purple-400">${TOTAL_BONUS_VALUE}</span></p>
        </div>
      ...
      <div className="hidden sm:block space-y-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-xl glass-premium border border-purple-500/20 text-white placeholder-slate-500 focus:border-purple-400 focus:outline-none focus:ring-4 focus:ring-purple-400/10 transition-all"
          />
        </div>
          ...
          {BONUS_CATEGORIES.map((cat) => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-all ${
                categoryFilter === cat
                  ? 'btn-premium text-white shadow-glow-purple'
                  : 'glass-dark text-slate-300 hover:border-purple-500/50'
              }`}
            >
              {cat}
            </button>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredBonuses.map((bonus) => {
          ...
          return (
            <div key={bonus.id} className="glass-premium rounded-2xl border border-purple-500/20 overflow-hidden hover-lift group">
              {/* Bonus Image */}
              <div className="relative aspect-[16/10] bg-gradient-hero overflow-hidden">
                ...
                />
                <div className="absolute top-2 right-2 px-2 py-1 rounded-lg glass-dark border border-purple-500/30">
              ...
              <div className="p-4">
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-violet-500 flex items-center justify-center shadow-glow-purple flex-shrink-0">
    ...
    <div className="space-y-4 sm:space-y-6 animate-fade-in">
      ...
      <div className="sm:hidden grid grid-cols-3 gap-3">
        {[
          ...
          { label: 'Points', value: state.totalPoints, color: 'from-purple-500 to-violet-500' },
          { label: 'Streak', value: `${state.streak}d`, color: 'from-rose-500 to-pink-500' },
        ].map((stat, i) => (
          <div key={i} className="glass-premium rounded-2xl p-4 text-center border border-purple-500/20">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-white/10">
                  ...
                  <span className={`text-sm font-bold ${isUnlocked ? 'text-purple-400' : 'text-slate-500'}`}>
      ...
      {state.progressPercent >= 100 && (
        <div className="relative overflow-hidden rounded-2xl bg-gradient-hero p-6 sm:p-8 text-center border border-purple-500/20 section-premium noise-overlay">
          {/* Floating Gradient Orbs */}
          <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-br from-purple-500/20 to-violet-500/10 rounded-full blur-3xl floating" />
          <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-br from-violet-500/15 to-purple-500/5 rounded-full blur-3xl floating-slow" />

          <div className="relative z-10">
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-purple-500 to-violet-500 flex items-center justify-center shadow-glow-purple">
