  ...
  return (
    <div className="space-y-4 sm:space-y-8 animate-fade-in">
      ...
      <div className="sm:hidden relative overflow-hidden rounded-3xl bg-gradient-premium p-5 border border-cyan-500/20 noise-overlay section-premium">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-cyan-400 text-xs font-bold uppercase tracking-wider mb-1">Welcome back</p>
          ...
          <div className="mb-4">
            <div className="flex justify-between text-xs mb-2">
              ...
              <span className="text-cyan-400 font-bold">{state.timeRemaining} min left</span>
            </div>
      ...
      <div className="hidden sm:block relative overflow-hidden rounded-3xl bg-gradient-hero p-8 text-white section-premium noise-overlay border border-cyan-500/20">
        ...
        <div className="relative z-10">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="font-bold text-cyan-400">{Math.round(state.progressPercent)}%</span>
          </div>
        </div>
      </div>
      ...
      <div className="hidden sm:grid grid-cols-3 lg:grid-cols-5 gap-4">
        <div className="glass-premium rounded-2xl p-6 hover-lift col-span-1 border border-cyan-500/20">
        ...
        {[
          ...
          <div key={i} className="glass-premium rounded-2xl p-6 hover-lift border border-cyan-500/10">
            <div className="flex items-center gap-4">
      ...
      {state.progressPercent < 100 && (
        <div className="sm:hidden">
          <h3 className="text-sm font-bold text-cyan-400 uppercase tracking-wider mb-3 px-1">Up Next</h3>
          <button
            onClick={() => {
              state.setCurrentModuleIndex(state.nextIncompleteModuleIndex)
              state.setActiveSection('course')
      ...
      {showWelcomeVideo && (
        <div className="glass-premium rounded-3xl shadow-2xl border border-cyan-500/20 overflow-hidden">
      ...
      <div className="hidden sm:grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 glass-premium rounded-2xl p-6 border border-cyan-500/20">
          <h2 className="text-xl font-black text-white mb-4">
            {state.progressPercent >= 100 ? 'Course Complete!' : 'Continue Learning'}
          </h2>
          {state.progressPercent >= 100 ? (
            <div className="text-center py-6">
              <div className="w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br from-emerald-400 to-cyan-500 flex items-center justify-center shadow-glow-teal mb-4">
      ...
      <div className="sm:hidden rounded-2xl glass-premium p-4 border border-cyan-500/20">
      ...
      <div className="hidden sm:block glass-premium rounded-2xl p-5 border border-cyan-500/20">
        ...
        <div className="relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {COMING_SOON_COURSES.map((course) => {
              ...
              return (
                <div key={course.id} className="relative group glass-premium rounded-xl p-5 border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300 hover-lift">
                  ...
                  <div className="flex items-center justify-between text-sm mb-4">
                    <span className="text-slate-400"><span className="text-cyan-400 font-bold">{course.waitlistCount.toLocaleString()}</span> waiting</span>
                  ...
                  <button
                    ...
                    className={`w-full py-3 rounded-xl font-bold text-sm transition-all duration-300 flex items-center justify-center gap-2 ${
                      isWaitlisted
                        ? 'glass-teal text-cyan-400 border border-cyan-500/30'
    ...
    <div {...swipeHandlers} className="space-y-4 sm:space-y-6 animate-fade-in touch-pan-y">
      ...
      <div className="sm:hidden flex items-center justify-between">
        ...
        <div className="text-center">
          <p className="text-xs text-cyan-400 font-bold">Module {currentModule.number}</p>
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className={`p-2 rounded-xl transition-all ${isBookmarked ? 'text-cyan-400 glass-teal' : 'text-slate-400'}`}
          >
      ...
      <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl shadow-cyan-500/10 glass-premium border border-cyan-500/20">
        {!currentModule.comingSoon && currentModule.wistiaId ? (
          ...
          <div className="aspect-video bg-gradient-hero flex items-center justify-center">
            <div className="text-center">
              <div className="w-16 h-16 rounded-2xl glass-premium flex items-center justify-center mx-auto mb-4 border border-cyan-500/20">
      ...
      <div className="hidden sm:grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          {currentModule.resources.length > 0 && (
            <div className="glass-premium rounded-2xl p-6 border border-cyan-500/20">
              <h3 className="font-bold text-white mb-4 flex items-center gap-2">
                <Download className="w-5 h-5 text-cyan-400" /> Resources
              </h3>
              <div className="space-y-3">
        ...
        <div className="space-y-4">
          <div className="glass-premium rounded-2xl p-5 border border-cyan-500/20">
            <div className="flex items-center justify-between mb-4">
                    ...
                    <div className={`relative ${
                      ...
                      <div className={`relative aspect-video bg-gradient-to-br ${gradientClass} overflow-hidden`}>
                        ...
                        {isCurrent && !moduleCompleted && (
                          <div className="absolute top-2 left-2 px-1.5 py-0.5 rounded bg-cyan-500 text-[10px] font-bold text-white animate-pulse">
                            Playing
                          </div>
                        )}
                      </div>
                ...
                <div className={`relative overflow-hidden rounded-2xl border transition-all duration-300 ${
                  isComingSoon
                    ...
                    : moduleCompleted
                      ...
                      : 'glass-dark border-slate-700/50 hover:border-cyan-500/30'
                }`}>
                      ...
                      {module.lessons.slice(0, 2).map((lesson, i) => (
                        <div key={i} className="flex items-center gap-2">
                          <div className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${
                            moduleCompleted ? 'bg-emerald-400' : 'bg-cyan-400'
                          }`} />
    ...
    <div className="space-y-4 sm:space-y-6 animate-fade-in">
      ...
      <div className="hidden sm:flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black text-white flex items-center gap-3">
            <Gift className="w-8 h-8 text-cyan-400" /> Bonus Resources
          </h1>
          <p className="text-slate-400 mt-1">Resources worth <span className="font-bold text-cyan-400">${TOTAL_BONUS_VALUE}</span></p>
        </div>
      ...
      <div className="hidden sm:block space-y-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-xl glass-premium border border-cyan-500/20 text-white placeholder-slate-500 focus:border-cyan-400 focus:outline-none focus:ring-4 focus:ring-cyan-400/10 transition-all"
          />
        </div>
          ...
          {BONUS_CATEGORIES.map((cat) => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-all ${
                categoryFilter === cat
                  ? 'btn-premium text-white shadow-glow-teal'
                  : 'glass-dark text-slate-300 hover:border-cyan-500/50'
              }`}
            >
              {cat}
            </button>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredBonuses.map((bonus) => {
          ...
          return (
            <div key={bonus.id} className="glass-premium rounded-2xl border border-cyan-500/20 overflow-hidden hover-lift group">
              {/* Bonus Image */}
              <div className="relative aspect-[16/10] bg-gradient-hero overflow-hidden">
                ...
                />
                <div className="absolute top-2 right-2 px-2 py-1 rounded-lg glass-dark border border-cyan-500/30">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-white/10">
                  ...
                  <span className={`text-sm font-bold ${isUnlocked ? 'text-cyan-400' : 'text-slate-500'}`}>
