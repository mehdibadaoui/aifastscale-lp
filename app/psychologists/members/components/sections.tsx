  ...
  return (
    <div className="space-y-4 sm:space-y-8 animate-fade-in">
      ...
      <div className="sm:hidden relative overflow-hidden rounded-3xl bg-gradient-premium p-5 border border-purple-500/20 noise-overlay section-premium">
        ...
        <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-purple-500/20 to-amber-500/10 rounded-full blur-3xl floating" />
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-br from-amber-500/15 to-purple-500/5 rounded-full blur-3xl floating-slow" style={{ animationDelay: '2s' }} />
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500 to-amber-500 flex items-center justify-center shadow-glow-teal">
      ...
      <div className="hidden sm:block relative overflow-hidden rounded-3xl bg-gradient-hero p-8 text-white section-premium noise-overlay border border-purple-500/20">
        ...
        <div className="absolute top-0 right-0 w-80 h-80 bg-gradient-to-br from-purple-500/15 to-amber-500/5 rounded-full blur-3xl floating-slow" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-br from-amber-500/10 to-purple-500/5 rounded-full blur-3xl floating" style={{ animationDelay: '2s' }} />
        <div className="relative z-10">
          ...
          <div className="bg-black/30 backdrop-blur-sm rounded-full h-4 mb-2 overflow-hidden border border-purple-500/20">
            <div className="h-full bg-gradient-to-r from-purple-500 to-amber-400 rounded-full transition-all duration-500" style={{ width: `${state.progressPercent}%` }} />
          </div>
      ...
      <div className="sm:hidden grid grid-cols-2 gap-3">
        {[
          { icon: Clock, label: 'Watch Time', value: `${state.totalWatchTimeMinutes}m`, color: 'from-purple-500 to-amber-500', iconColor: '#9333ea' },
      ...
      <div className="hidden sm:grid grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        {[
          { icon: Clock, label: 'Watched', value: `${state.totalWatchTimeMinutes}m`, color: 'from-purple-500 to-amber-500' },
      ...
      {state.progressPercent < 100 && (
        <div className="sm:hidden">
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-500 to-amber-500 flex items-center justify-center shadow-glow-teal flex-shrink-0">
        ...
        <div className="lg:col-span-2 glass-premium rounded-2xl p-6 border border-purple-500/20">
          ...
          {state.progressPercent >= 100 ? (
            <div className="text-center py-6">
              <div className="w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br from-emerald-400 to-purple-500 flex items-center justify-center shadow-glow-teal mb-4">
            ...
            >
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-purple-500 to-amber-500 flex items-center justify-center shadow-glow-teal relative flex-shrink-0">
      ...
      <div className="hidden sm:block relative overflow-hidden rounded-2xl bg-gradient-hero p-8 section-premium noise-overlay border border-purple-500/20">
        {/* Floating Gradient Orbs */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-purple-500/10 to-amber-500/5 rounded-full blur-3xl floating-slow" />
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-br from-amber-500/10 to-purple-500/5 rounded-full blur-3xl floating" style={{ animationDelay: '2s' }} />
                ...
                <div key={course.id} className="relative group glass-premium rounded-xl p-5 border border-purple-500/20 hover:border-purple-400/40 transition-all duration-300 hover-lift">
                  ...
                  <button
                    ...
                    className={`w-full py-3 rounded-xl font-bold text-sm transition-all duration-300 flex items-center justify-center gap-2 ${
                      isWaitlisted
                        ? 'glass-teal text-purple-400 border border-purple-500/30'
    ...
    <div {...swipeHandlers} className="space-y-4 sm:space-y-6 animate-fade-in touch-pan-y">
      ...
      <div className="sm:hidden flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className={`p-2 rounded-xl transition-all ${isBookmarked ? 'text-purple-400 glass-teal' : 'text-slate-400'}`}
          >
      ...
      <div className="sm:hidden glass-premium rounded-2xl p-4 border border-purple-500/20">
        ...
        <div className="flex flex-wrap items-center gap-2 mb-3">
          <span className="px-3 py-1 rounded-full text-xs font-bold bg-gradient-to-r from-purple-500 to-amber-500 text-white shadow-lg">
              ...
              <div className="space-y-3">
                {currentModule.resources.map((resource, i) => (
                  <a
                    ...
                    className="flex items-center gap-4 p-4 rounded-xl glass-teal hover:border-purple-400/50 transition-all hover-lift"
                  >
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-amber-500 flex items-center justify-center flex-shrink-0 shadow-lg">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${
                            ...
                            {moduleCompleted ? (
                              ...
                              <Play className={`w-5 h-5 ${isCurrent ? 'text-purple-500' : 'text-slate-600'}`} fill={isCurrent ? '#9333ea' : '#475569'} />
                            )}
                          </div>
                        </div>
                ...
                <div className={`relative overflow-hidden rounded-2xl border transition-all duration-300 ${
                  ...
                  <div className="relative h-32 overflow-hidden">
                    ...
                    {module.thumbnail ? (
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-purple-500 to-amber-600" />
                    )}
    ...
    <div className="space-y-4 sm:space-y-6 animate-fade-in">
      ...
      <div className="sm:hidden">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="px-3 py-1.5 rounded-full bg-gradient-to-r from-purple-500 to-amber-500 text-white text-xs font-bold shadow-glow-teal">
            ...
            <div key={bonus.id} className="glass-premium rounded-2xl border border-purple-500/20 overflow-hidden hover-lift group">
              ...
              <div className="p-4">
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-amber-500 flex items-center justify-center shadow-glow-teal flex-shrink-0">
    ...
    <div className="space-y-4 sm:space-y-6 animate-fade-in">
      ...
      <div className="sm:hidden grid grid-cols-3 gap-3">
        {[
          ...
          { label: 'Points', value: state.totalPoints, color: 'from-purple-500 to-amber-500' },
      ...
      {state.progressPercent >= 100 && (
        <div className="relative overflow-hidden rounded-2xl bg-gradient-hero p-6 sm:p-8 text-center border border-purple-500/20 section-premium noise-overlay">
          {/* Floating Gradient Orbs */}
          <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-br from-purple-500/20 to-amber-500/10 rounded-full blur-3xl floating" />
          <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-br from-amber-500/15 to-purple-500/5 rounded-full blur-3xl floating-slow" />

          <div className="relative z-10">
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-purple-500 to-amber-500 flex items-center justify-center shadow-glow-teal">
