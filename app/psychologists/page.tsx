  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute top-10 right-0 w-[500px] h-[500px] bg-gradient-to-br from-sky-600/20 to-violet-500/10 rounded-full blur-[100px] floating-slow" />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-sky-500/10 to-fuchsia-500/5 rounded-full blur-[120px] floating-slow" style={{ animationDelay: '4s' }} />
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className={`mb-5 sm:mb-8 ${visibleSections.has('hero') ? 'animate-fade-in-up animation-delay-250' : ''}`}>
              <div className="inline-flex items-center gap-2 badge-premium badge-glow">
                ...
                <span className="text-sky-300 font-semibold text-xs sm:text-sm">Dr. Maya Martinez, MD, FACS — Board-Certified Psychologist</span>
              </div>
            </div>
            ...
            <div className={`flex flex-wrap items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8 stagger-fast ${visibleSections.has('hero') ? 'visible' : ''}`}>
              ...
              <div className="flex items-center gap-1.5 glass-teal px-4 py-2.5 rounded-full hover-scale">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-3 h-3 sm:w-4 sm:h-4 fill-sky-400 text-sky-400" />
                ))}
            ...
            <div className={`max-w-xl mx-auto mt-8 ${visibleSections.has('hero') ? 'animate-fade-in-up animation-delay-500' : ''}`}>
              ...
              >
                <span className="text-sky-400 font-medium border-b border-dashed border-sky-400/40 group-hover:border-sky-400 transition-colors">
                  What is the CloneYourself System?
                </span>
                <ChevronDown className={`w-4 h-4 text-sky-400 transition-transform duration-300 ${expandedFaq === -1 ? 'rotate-180' : ''}`} />
              </button>
              ...
              <div className={`overflow-hidden transition-all duration-500 ease-out ${expandedFaq === -1 ? 'max-h-[600px] opacity-100 mt-4' : 'max-h-0 opacity-0 mt-0'}`}>
                <div className="bg-gradient-to-br from-sky-500/10 to-white/5 backdrop-blur-sm border border-sky-500/20 rounded-xl p-5 text-left">
                  <p className="text-white text-sm leading-relaxed mb-3">
                    You upload <span className="text-sky-400 font-bold">one clear selfie</span> to a free AI software — the #1 tool for generating realistic talking videos in {new Date().getFullYear()}.
                  </p>
                  <p className="text-white/80 text-sm leading-relaxed mb-3">
                    The AI transforms your photo into a <span className="text-sky-400 font-bold">talking video of YOU</span> — your face moves, your lips sync perfectly, it looks 100% real. No filming. No editing. No experience needed.
                  </p>
        ...
        <div className="w-full px-3 sm:px-6 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-6 sm:mb-12">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-sky-500/20 to-amber-500/20 border border-sky-500/40 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full mb-3 sm:mb-4">
              ...
              <h2 className="text-xl sm:text-4xl md:text-5xl font-black text-white mb-2 sm:mb-3 leading-tight">
                Works in <span className="bg-gradient-to-r from-sky-400 to-amber-400 bg-clip-text text-transparent">Your Language</span>
              </h2>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-6 sm:mb-8">
              <div className="bg-white/5 border border-white/10 rounded-lg sm:rounded-xl p-2.5 sm:p-4 text-center">
                <div className="text-lg sm:text-3xl font-black text-sky-400">3,247+</div>
            ...
            <div className="mb-5 sm:mb-6">
              <div className="relative max-w-md mx-auto">
                ...
                <input
                  ...
                  className="w-full bg-white/10 border border-white/20 rounded-full pl-11 sm:pl-12 pr-4 py-2.5 sm:py-3 text-white text-sm placeholder-gray-500 focus:outline-none focus:border-sky-500/50 transition-all"
                />
                {languageSearch && (
                  <button
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-6 mb-5 sm:mb-6">
              <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2 sm:gap-3">
                {displayedLanguages.map((lang) => (
                  ...
                  >
                    <div className="bg-white/5 border border-white/10 rounded-lg p-1.5 sm:p-3 hover:bg-white/10 hover:border-sky-500/30 transition-all">
              ...
              {filteredLanguages.length === 0 && (
                <div className="text-center py-6">
                  ...
                  <button
                    onClick={() => setLanguageSearch('')}
                    className="text-sky-400 hover:text-sky-300 text-sm mt-3 underline"
                  >
                    Clear search
                  </button>
                </div>
              ...
              {!languageSearch && hiddenCount > 0 && (
                <div className="text-center mt-4 pt-4 border-t border-white/10">
                  <button
                    ...
                    className="inline-flex items-center gap-2 bg-sky-500/20 hover:bg-sky-500/30 border border-sky-500/30 text-sky-400 px-4 py-2 rounded-full text-sm font-medium transition-all"
                  >
                    {showAllLanguages ? (
                      <>
            ...
            <div className="bg-gradient-to-r from-sky-500/10 to-amber-500/10 border border-sky-500/20 rounded-xl sm:rounded-2xl p-4 sm:p-6">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-sky-500 to-amber-500 flex items-center justify-center text-white text-sm sm:text-xl font-bold">
                    CS
                  </div>
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-white text-xs sm:text-base leading-relaxed mb-2 sm:mb-3">
                    "The Portuguese accent is <span className="text-sky-400 font-semibold">perfect</span> — my clients can't tell it's AI. Session requests tripled. <span className="text-amber-400 font-semibold">Worth every penny.</span>"
                  </p>
            ...
            <div className="text-center mt-4 sm:mt-6">
              <p className="text-gray-500 text-[10px] sm:text-sm">
                ...
                New languages added monthly • <a href="mailto:support@aifastscale.com" className="text-sky-400 hover:underline">Request yours</a>
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-10 left-10 w-2 h-2 bg-sky-500/30 rounded-full animate-ping" />
          <div className="absolute top-1/3 right-20 w-3 h-3 bg-amber-500/20 rounded-full animate-pulse" />
          <div className="absolute bottom-20 left-1/4 w-2 h-2 bg-sky-400/30 rounded-full animate-bounce" />
        ...
        <div className="w-full px-3 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className={`bg-gradient-to-br from-white/10 to-white/5 border-2 border-sky-500/40 rounded-xl sm:rounded-2xl p-5 sm:p-10 backdrop-blur-sm ${
              visibleSections.has('refund-policy-top') ? 'animate-fade-in-up' : ''
            }`}>
              <div className="text-center mb-6 sm:mb-10">
                <div className="inline-flex items-center gap-2 bg-sky-500/20 border border-sky-500/40 rounded-full px-3 py-1.5 sm:px-4 sm:py-2 mb-3 sm:mb-4">
                  <Smile className="w-4 h-4 sm:w-5 sm:h-5 text-sky-400 animate-bounce" />
                  <span className="text-sky-400 font-bold text-xs sm:text-sm uppercase">No Hassle Policy</span>
                </div>
                <h2 className="text-2xl sm:text-4xl font-black text-white mb-2 sm:mb-4">
                  Need a Refund? <span className="text-sky-400">It's THIS Easy</span>
                </h2>
                <p className="text-gray-400 text-sm sm:text-lg max-w-2xl mx-auto">
              ...
              <div className="relative">
                {/* Connecting Line */}
                <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-sky-500 via-amber-500 to-green-500 -translate-x-1/2 hidden md:block" />
                ...
                <div className="space-y-4">
                  ...
                  <div className={`relative flex flex-col md:flex-row items-center gap-3 md:gap-4 ${visibleSections.has('refund-policy-top') ? 'animate-fade-in-up' : ''}`}>
                    ...
                    <div className="relative z-10 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-sky-500 to-amber-500 rounded-full flex items-center justify-center shadow-lg shadow-sky-500/40 md:order-2">
                      ...
                      <div className="absolute -top-1 -right-1 w-5 h-5 sm:w-6 sm:h-6 bg-white rounded-full flex items-center justify-center shadow-md">
                        <span className="text-sky-600 font-black text-xs sm:text-sm">1</span>
                      </div>
                    </div>
                    {/* Content */}
                    <div className="w-full md:flex-1 md:text-right md:order-1">
                      <div className="bg-gradient-to-r from-sky-500/20 to-transparent rounded-xl p-4 border border-sky-500/30">
                  ...
                  <div className={`relative flex flex-col md:flex-row items-center gap-3 md:gap-4 ${visibleSections.has('refund-policy-top') ? 'animate-fade-in-up animation-delay-200' : ''}`}>
                    {/* Icon */}
                    <div className="relative z-10 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-amber-500 to-sky-500 rounded-full flex items-center justify-center shadow-lg shadow-amber-500/40 md:order-2">
              ...
              <div className="mt-6 sm:mt-10 text-center">
                <div className="inline-block bg-gradient-to-r from-sky-500/20 via-amber-500/20 to-green-500/20 rounded-xl p-4 sm:p-6 border border-white/10">
                  <p className="text-white font-bold text-sm sm:text-lg mb-2">
                    That's it. <span className="text-sky-400">3 simple steps.</span>
                  </p>
        ...
        <div className="w-full px-3 sm:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className={`text-center mb-8 sm:mb-12 relative z-10 ${visibleSections.has('case-study') ? 'animate-fade-in-down' : ''}`}>
              <div className="inline-flex items-center gap-2 bg-sky-500/20 border border-sky-500/40 px-4 py-2 rounded-full mb-4 hover-scale">
              ...
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-gray-900 mb-3 sm:mb-4 leading-tight">
                Dr. Daniel Booked <span className="text-sky-600">$156K in Sessions</span>...
              </h2>
            ...
            <div className={`relative bg-gradient-to-br from-zinc-900 via-black to-zinc-900 border border-sky-500/20 rounded-2xl sm:rounded-3xl overflow-hidden card-hover ${visibleSections.has('case-study') ? 'animate-scale-in animation-delay-200' : ''}`}>

              {/* Glow Effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-sky-500/5 via-transparent to-sky-500/5 pointer-events-none" />
              ...
              <div className="relative p-4 sm:p-8">
                ...
                <div className="relative w-full rounded-2xl overflow-hidden border-2 border-sky-500/30 shadow-2xl shadow-sky-500/10 bg-black aspect-square max-w-md mx-auto">
                ...
                <div className="flex justify-center mt-4">
                  <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/30 px-4 py-2 rounded-full">
              ...
              {/* Results Strip */}
              <div className="bg-gradient-to-r from-sky-500/20 via-amber-500/20 to-sky-500/20 border-y border-sky-500/30 py-4 px-4 sm:px-8">
                <div className="grid grid-cols-3 gap-4 text-center">
                  {[
                    ...
                    <div key={i}>
                      <div className="text-sky-400 text-2xl sm:text-4xl font-black">{stat.number}</div>
              ...
              <div className="p-4 sm:p-8 border-t border-white/10">
                <div className="text-center mb-4 sm:mb-6">
                  <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/30 px-3 py-1.5 rounded-full">
                    <span className="text-sky-400 text-xs font-bold">FROM SKEPTIC TO BELIEVER</span>
                  </div>
                </div>
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3">
                      <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                        ...
                        item.color === 'teal' ? 'bg-sky-500/20 border border-sky-500/40' :
                        'bg-white/5 border border-white/20'
                      }`}>
                        <item.icon className={`w-4 h-4 sm:w-5 sm:h-5 ${
                          item.color === 'green' ? 'text-green-400' :
                          item.color === 'teal' ? 'text-sky-400' :
                          'text-gray-400'
                        }`} />
                      </div>
                      <div className="flex-1 min-w-0">
                        <span className={`inline-block text-[10px] sm:text-xs font-black px-2 py-0.5 rounded mb-1 ${
                          ...
                          item.color === 'teal' ? 'bg-sky-500/20 text-sky-400' :
              ...
              {/* Final Quote */}
              <div className="p-6 sm:p-8 bg-gradient-to-r from-sky-500/10 to-sky-500/5 border-t border-sky-500/30">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-white text-lg sm:text-xl font-medium italic leading-relaxed mb-4">
                      ...
                      <span className="text-sky-400 font-bold"> 28 qualified sessions in 4 weeks</span> — clients who already trusted me before walking in.
                      My OR is now booked 6 weeks out.
                    </p>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-sky-400 bg-gradient-to-br from-sky-500 to-violet-600 flex items-center justify-center">
              ...
              <div className="grid grid-cols-3 divide-x divide-white/10 bg-black/50">
                {[
                  ...
                  <div key={i} className="p-4 sm:p-6 text-center">
                    <div className={`text-xl sm:text-2xl font-black mb-1 ${i === 1 ? 'text-sky-400' : i === 2 ? 'text-green-400' : 'text-white'}`}>{stat.value}</div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className={`text-center mb-6 sm:mb-12 ${visibleSections.has('whats-inside') ? 'animate-blur-in' : ''}`}>
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-white mb-2 sm:mb-4">
                Here's What You Get <span className="text-sky-400">Today</span>
              </h2>
            ...
            <div className={`bg-gradient-to-br from-sky-500/15 to-sky-500/5 border-2 border-sky-500 rounded-xl sm:rounded-2xl overflow-hidden mb-4 sm:mb-6 card-hover img-zoom ${
              ...
              <div className="p-4 sm:p-8">
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                  <span className="bg-sky-500 text-white px-2 sm:px-3 py-0.5 sm:py-1 rounded-lg text-[10px] sm:text-xs font-black">MAIN TRAINING</span>
                  <span className="text-gray-400 line-through text-xs sm:text-sm">$497</span>
                  <span className="text-sky-400 font-black text-xs sm:text-base">INCLUDED</span>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 sm:gap-2">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-2 text-gray-300 text-xs sm:text-sm">
                      <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-sky-400 flex-shrink-0" />
                      <span>{item}</span>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-4 pt-4 border-t border-white/10">
                  <p className="text-gray-400 text-xs sm:text-sm flex items-center gap-2">
                    ...
                    <span>Clinically-structured lessons and examples created with input from <span className="text-sky-400 font-medium">Dr. Maya Martinez</span>, Board-Certified Psychologist, MD, FACS</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={`text-center mb-4 sm:mb-6 ${visibleSections.has('whats-inside') ? 'animate-fade-in-up animation-delay-300' : ''}`}>
              <div className="inline-flex items-center gap-2 bg-sky-500/20 border border-sky-500/40 px-3 sm:px-5 py-1.5 sm:py-2 rounded-full">
                <Gift className="w-4 h-4 sm:w-5 sm:h-5 text-sky-400" />
                <span className="text-sky-400 font-black text-sm sm:text-base">+ 10 BONUSES (${totalBonusValue} Value)</span>
              </div>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
              {allBonuses.map((bonus, index) => (
                <div key={bonus.id} className={`bg-gradient-to-br from-white/8 to-white/3 border border-sky-500/30 rounded-xl sm:rounded-2xl overflow-hidden hover:border-sky-500/50 hover:shadow-lg hover:shadow-sky-500/10 transition-all duration-300 ${visibleSections.has('whats-inside') ? 'animate-fade-in-up' : ''}`}>
            ...
            <div className={`grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 ${visibleSections.has('whats-inside') ? 'animate-fade-in-up' : ''}`}>
              <div className="bg-gradient-to-br from-sky-500/10 to-transparent border border-sky-500/30 rounded-xl p-5">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 bg-sky-500 rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sky-400 font-bold text-sm mt-1">$197 value — FREE</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-sky-500/10 to-transparent border border-sky-500/30 rounded-xl p-5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sky-400 font-bold text-sm mt-1">$297 value — FREE</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={`bg-gradient-to-br from-sky-500/20 to-black rounded-2xl border-2 border-sky-500 p-4 sm:p-8 ${
              visibleSections.has('whats-inside') ? 'animate-fade-in-up' : ''
            }`}>
              {/* Price Box - Compact */}
              <div className="bg-black/50 rounded-xl p-4 sm:p-6 mb-4 sm:mb-6 text-center border border-sky-500/30">
                <p className="text-sky-400 font-bold text-sm sm:text-base mb-2">Get Everything Today For</p>
                <div className="flex items-center justify-center gap-2 sm:gap-3 mb-1">
                  <span className="text-4xl sm:text-6xl font-black text-sky-400">$47.82</span>
              ...
              <Link
                onClick={trackInitiateCheckout} href={WHOP_CHECKOUT_LINK}
                                className="w-full bg-gradient-to-r from-sky-500 to-amber-500 text-white py-4 sm:py-5 rounded-xl font-black text-base sm:text-xl shadow-xl flex items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4 hover:scale-[1.02] active:scale-[0.98] transition-transform"
              >
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-gray-400 text-xs sm:text-sm">
                ...
                <div className="flex items-center gap-1.5">
                  <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-sky-400" />
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                {[
                  ...
                  <div key={i} className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-sky-500/20 rounded-full flex items-center justify-center mx-auto mb-2">
                      <span className="text-sky-400 font-black text-lg sm:text-xl">{item.step}</span>
                    </div>
      ...
      >
        ...
        <div className="absolute top-20 left-10 w-32 h-32 bg-sky-500/5 rounded-full blur-3xl" />
        ...
        <div className="w-full px-3 sm:px-6 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className={`text-center mb-8 sm:mb-14 ${visibleSections.has('how-it-works') ? 'animate-zoom-in' : ''}`}>
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-sky-500/10 to-amber-500/10 border border-sky-500/30 px-4 py-2 rounded-full mb-4 hover-scale">
                <Zap className="w-4 h-4 text-sky-500 animate-pulse" />
                <span className="text-sky-600 font-black text-xs uppercase tracking-wide">4 Simple Steps</span>
              ...
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-gray-900 mb-3 sm:mb-4">
                From Zero to <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-amber-500">AI Video</span> in Minutes
              </h2>
            ...
            <div className="relative">
              ...
              <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-sky-500 via-amber-500 to-green-500 -translate-y-1/2 rounded-full opacity-20" />
              ...
              <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 stagger-children ${visibleSections.has('how-it-works') ? 'visible' : ''}`}>
                ...
                <div className="group relative">
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-5 sm:p-6 border-2 border-gray-100 hover:border-sky-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-sky-500/10 h-full hover-lift">
                    {/* Step number - floating */}
                    <div className="absolute -top-3 -left-2 sm:-top-4 sm:-left-3">
                      <div className="relative">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-sky-500 to-amber-500 rounded-xl flex items-center justify-center shadow-lg shadow-sky-500/30 group-hover:scale-110 transition-transform">
                    ...
                    <div className="flex justify-end mb-4 mt-2">
                      <span className="bg-sky-500/10 text-sky-600 px-3 py-1 rounded-full text-xs font-bold border border-sky-500/20">
                        5 min
                      </span>
                    </div>

                    {/* Icon */}
                    <div className="w-14 h-14 bg-gradient-to-br from-sky-500/20 to-amber-500/10 rounded-xl flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
                    ...
                    <p className="text-gray-500 text-sm leading-relaxed">
                      Use our <span className="text-sky-600 font-semibold">ChatGPT specialist</span> built for plastic therapy practices. Just describe your topic.
                    </p>
                ...
                <div className="group relative">
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-5 sm:p-6 border-2 border-gray-100 hover:border-amber-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-amber-500/10 h-full hover-lift">
                    ...
                    <div className="absolute -top-3 -left-2 sm:-top-4 sm:-left-3">
                      <div className="relative">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-amber-500 to-sky-500 rounded-xl flex items-center justify-center shadow-lg shadow-amber-500/30 group-hover:scale-110 transition-transform">
                    ...
                    {/* Icon */}
                    <div className="w-14 h-14 bg-gradient-to-br from-amber-500/20 to-sky-500/10 rounded-xl flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
                ...
                <div className="group relative">
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-5 sm:p-6 border-2 border-gray-100 hover:border-sky-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-sky-500/10 h-full hover-lift">
                    ...
                    <div className="absolute -top-3 -left-2 sm:-top-4 sm:-left-3">
                      <div className="relative">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-sky-500 to-green-500 rounded-xl flex items-center justify-center shadow-lg shadow-sky-500/30 group-hover:scale-110 transition-transform">
                          <span className="text-white font-black text-lg sm:text-xl">3</span>
                        </div>
                        <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-gradient-to-r from-sky-500 to-amber-500 rounded-full flex items-center justify-center">
                    ...
                    {/* Icon */}
                    <div className="w-14 h-14 bg-gradient-to-br from-sky-500/20 to-green-500/10 rounded-xl flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
                    ...
                    <p className="text-gray-500 text-sm leading-relaxed">
                      AI generates a <span className="text-sky-600 font-semibold">realistic talking video</span> with perfect lip-sync. Like magic.
                    </p>
            ...
            <div className={`flex justify-center mt-8 sm:mt-12 ${visibleSections.has('how-it-works') ? 'animate-fade-in-up animation-delay-500' : ''}`}>
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-sky-500 to-amber-500 rounded-full blur-xl opacity-20 animate-pulse" />
                <div className="relative flex items-center gap-4 sm:gap-6 bg-gradient-to-r from-gray-900 to-gray-800 rounded-full px-6 sm:px-10 py-3 sm:py-4 shadow-2xl">
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-amber-400 font-black text-2xl sm:text-4xl">~20</span>
            ...
            <div className={`flex flex-col items-center mt-8 sm:mt-12 ${visibleSections.has('how-it-works') ? 'animate-fade-in-up animation-delay-600' : ''}`}>
              <a
                onClick={trackInitiateCheckout} href={WHOP_CHECKOUT_LINK}
                                className="group relative inline-flex items-center justify-center bg-gradient-to-r from-sky-500 via-amber-500 to-sky-500 text-white px-8 sm:px-12 py-4 sm:py-5 rounded-xl font-black text-base sm:text-xl hover:scale-105 active:scale-95 transition-all shadow-2xl shadow-sky-500/30"
              >
        ...
        <div className="w-full px-3 sm:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className={`text-center mb-6 sm:mb-10 ${visibleSections.has('case-study') ? 'animate-fade-in-up' : ''}`}>
              <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/30 px-3 py-1.5 rounded-full mb-3">
                <Play className="w-3.5 h-3.5 text-sky-500" />
                <span className="text-sky-600 font-bold text-xs uppercase tracking-wide">Facial Rejuvenation Success</span>
              </div>
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-gray-900 mb-2 sm:mb-4">
                His First AI Video Generated <span className="text-sky-500">$189,000</span> in Facelift Cases
              </h2>
            ...
            <div className={`bg-white border border-gray-200 rounded-xl sm:rounded-2xl overflow-hidden shadow-xl ${visibleSections.has('case-study') ? 'animate-fade-in-up animation-delay-200' : ''}`}>
              ...
              <div className="p-4 sm:p-8 border-b border-gray-100">
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
                  ...
                  <div className="flex items-center gap-4 sm:flex-col sm:items-center sm:text-center">
                    <div className="relative">
                      <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-3 border-sky-500 shadow-lg bg-gradient-to-br from-sky-500 to-violet-600 flex items-center justify-center">
                        <span className="text-white font-bold text-2xl">MC</span>
                      </div>
                      <div className="absolute -bottom-1 -right-1 bg-sky-500 text-white text-[10px] font-black px-2 py-0.5 rounded-full">
                        VERIFIED
                      </div>
                    </div>
                    <div className="sm:mt-2">
                      <h3 className="text-gray-900 font-black text-lg">Dr. Michael Chen</h3>
                      <p className="text-sky-600 text-sm font-medium">Facial Psychologist</p>
              ...
              <div className="p-6 sm:p-8 bg-gray-50">
                <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/30 px-3 py-1 rounded-full mb-4">
                  <span className="text-sky-600 text-xs font-bold">HIS FIRST AI VIDEO</span>
                </div>

                <div className="relative rounded-xl overflow-hidden border-2 border-sky-500/40 shadow-2xl">
                ...
                <p className="text-gray-500 text-sm mt-3 text-center">
                  Created in <span className="text-sky-600 font-bold">7 minutes</span> • Posted on Instagram Reels • Day 1 of using the system
                </p>
              </div>
              ...
              <div className="p-6 sm:p-8 bg-white border-t border-gray-100">
                <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/30 px-3 py-1 rounded-full mb-4">
                  <span className="text-sky-600 text-xs font-bold">THE SPEED OF AI CONTENT</span>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={i} className="bg-gradient-to-br from-purple-50 to-white border border-sky-500/30 rounded-xl p-4 text-center">
                      <div className="text-sky-500 text-4xl sm:text-5xl font-black mb-1">{stat.number}</div>
              ...
              <div className="p-4 sm:p-8 border-t border-gray-100 bg-gray-50">
                <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/30 px-3 py-1 rounded-full mb-4 sm:mb-6">
                  <span className="text-sky-600 text-xs font-bold">THE TIMELINE</span>
                </div>
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3">
                      <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                        ...
                        item.color === 'teal' ? 'bg-purple-100 border border-sky-500/40' :
                        'bg-gray-100 border border-gray-300'
                      }`}>
                        <item.icon className={`w-4 h-4 sm:w-5 sm:h-5 ${
                          item.color === 'green' ? 'text-green-600' :
                          item.color === 'teal' ? 'text-sky-600' :
                          'text-gray-500'
                        }`} />
                      </div>
                      <div className="flex-1 min-w-0">
                        <span className={`inline-block text-[10px] sm:text-xs font-black px-2 py-0.5 rounded mb-1 ${
                          ...
                          item.color === 'teal' ? 'bg-purple-100 text-sky-600' :
              ...
              {/* Final Quote */}
              <div className="p-6 sm:p-8 bg-gradient-to-r from-sky-500/10 to-purple-50 border-t border-sky-500/20">
                <div className="flex items-start gap-4">
                  <div className="text-sky-500 text-4xl font-serif leading-none">"</div>
                  <div>
                    <p className="text-gray-800 text-lg sm:text-xl font-medium italic leading-relaxed mb-4">
                      Two weeks of AI videos. <span className="text-sky-600 font-bold">$189,000 in facelift sessions</span>.
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-sky-500 bg-gradient-to-br from-sky-500 to-violet-600 flex items-center justify-center">
              ...
              <div className="grid grid-cols-3 divide-x divide-gray-200 bg-white">
                {[
                  ...
                  <div key={i} className="p-4 sm:p-6 text-center">
                    <div className={`text-xl sm:text-2xl font-black mb-1 ${i === 1 ? 'text-green-600' : i === 2 ? 'text-sky-500' : 'text-gray-900'}`}>{stat.value}</div>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-6 mb-6 sm:mb-10">
          <div className={`text-center ${visibleSections.has('testimonials') ? 'animate-fade-in-down' : ''}`}>
            <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/30 px-3 py-1.5 rounded-full mb-3 hover-scale sparkle">
              <Sparkles className="w-3.5 h-3.5 text-sky-400" />
              <span className="text-sky-400 font-bold text-xs uppercase tracking-wide">Success Stories</span>
            </div>
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-white mb-2 sm:mb-4">
              Real Psychologists. <span className="text-sky-400">Real Results.</span>
            </h2>
            <div className="flex items-center justify-center gap-3 sm:gap-6 text-gray-400 text-xs sm:text-base">
              <span><span className="text-sky-400 font-bold">500+</span> success stories</span>
              <span>•</span>
              <span><span className="text-sky-400 font-bold">20+</span> countries</span>
            </div>
          </div>
        </div>
          ...
          <div className="testimonial-scroll-track-psychologist">
            ...
            {testimonials.map((t) => (
              <div key={`first-${t.id}`} className="testimonial-card-psychologist">
                ...
                {/* Author - Larger image */}
                <div className="flex items-center gap-3">
                  <div className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-full overflow-hidden border-2 border-sky-500/40 shadow-lg">
        ...
        <div className="w-full px-3 sm:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className={`text-center mb-8 sm:mb-12 ${visibleSections.has('who-is-this-for') ? 'animate-blur-in' : ''}`}>
              <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/30 px-3 py-1.5 rounded-full mb-3 hover-scale">
                <Users className="w-3.5 h-3.5 text-sky-400" />
                <span className="text-sky-400 font-bold text-xs uppercase tracking-wide">Is This Right For You?</span>
              </div>
              <h2 className="text-2xl sm:text-4xl font-black text-white mb-2">
                This System Is <span className="text-sky-400">NOT</span> For Everyone
              </h2>
      ...
      >
        <div className="w-full px-3 sm:px-6">
          <div className="max-w-4xl mx-auto">
            <div className={`bg-gradient-to-br from-sky-500/10 to-white border-2 border-sky-500/40 rounded-xl sm:rounded-2xl p-5 sm:p-10 relative overflow-hidden ${
              visibleSections.has('guarantee1') ? 'animate-fade-in-up' : ''
            }`}>
              {/* Animated background pulse */}
              <div className="absolute inset-0 bg-gradient-to-r from-sky-500/5 via-amber-500/10 to-sky-500/5 animate-pulse" />
              ...
              <div className="relative z-10">
                <div className="text-center mb-5 sm:mb-8">
                  ...
                  <h2 className="text-2xl sm:text-4xl font-black text-gray-900 mb-2">
                    Fill Your Calendar or <span className="text-sky-500">100% Refund</span>
                  </h2>
                ...
                <div className="flex flex-col md:flex-row items-center gap-4 sm:gap-8">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-28 h-28 sm:w-40 sm:h-40 relative">
                      ...
                      {/* Main badge */}
                      <div className="absolute inset-2 rounded-full bg-gradient-to-br from-green-500 via-sky-500 to-green-500 shadow-2xl shadow-green-500/30 flex flex-col items-center justify-center">
                  ...
                  <div className="flex-1">
                    <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-sky-500/20 shadow-lg">
                      <p className="text-gray-800 text-sm sm:text-lg leading-relaxed font-medium">
                        ...
                        I'll refund <span className="text-sky-500 font-black">every single penny</span> — no questions asked.
                      </p>
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-4 mt-6 sm:mt-8">
                  {[
                    ...
                    <div key={i} className="bg-white rounded-xl p-3 sm:p-4 text-center border border-sky-500/20 shadow-lg hover:shadow-xl transition-shadow hover:scale-[1.02] transform duration-200">
                      <item.icon className="w-6 h-6 sm:w-8 sm:h-8 text-sky-500 mx-auto mb-1.5 sm:mb-2" />
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className={`text-center mb-8 sm:mb-10 ${visibleSections.has('comparison') ? 'animate-fade-in-up' : ''}`}>
              <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/30 px-3 py-1.5 rounded-full mb-3">
                ...
                <span className="text-sky-600 font-bold text-xs uppercase tracking-wide">Compare Your Options</span>
              </div>
              <h2 className="text-2xl sm:text-4xl font-black text-gray-900 mb-2">
                Why <span className="text-sky-500">CloneYourself</span> Beats Everything Else
              </h2>
                ...
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="text-center py-4 px-3 sm:px-4 bg-purple-50">
                      <div className="text-sky-600 font-bold text-sm">CloneYourself</div>
                      <div className="text-sky-400 text-xs">$47.82 one-time</div>
                    </th>
                  </tr>
                </thead>
                  ...
                  {[
                    ...
                    <tr key={i} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'}>
                      ...
                      <td className="py-3 px-3 sm:px-4 text-center bg-purple-50/50">
                        <span className="text-sky-600 font-bold text-sm flex items-center justify-center gap-1">
                          {row.us}
            ...
            <div className={`text-center mt-8 ${visibleSections.has('comparison') ? 'animate-fade-in-up animation-delay-300' : ''}`}>
              <a
                ...
                className="inline-flex items-center gap-2 bg-gradient-to-r from-sky-500 to-amber-500 text-white px-8 py-4 rounded-xl font-bold text-lg hover:scale-[1.02] transition-transform shadow-lg shadow-sky-500/25"
              >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className={`overflow-x-auto pb-2 -mx-3 px-3 sm:mx-0 sm:px-0 sm:overflow-visible mb-6 sm:mb-10 ${visibleSections.has('pricing') ? '' : ''}`}>
              <div className={`flex gap-3 sm:grid sm:grid-cols-3 sm:gap-4 stagger-fast ${visibleSections.has('pricing') ? 'visible' : ''}`} style={{ minWidth: 'max-content' }}>
                ...
                {/* Smart Way */}
                <div className="bg-gradient-to-br from-sky-500 to-amber-500 rounded-xl p-4 sm:p-6 border-2 border-white/20 relative shadow-xl sm:scale-105 flex-shrink-0 w-[200px] sm:w-auto hover-lift hover-glow">
                  <div className="absolute -top-2 sm:-top-3 right-3 sm:right-4 bg-black text-sky-400 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs font-black">
                    Best Value
                  </div>
                  <div className="flex items-center gap-2 mb-3 sm:mb-4 mt-1">
            ...
            <div className={`bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-5 sm:p-8 border border-sky-500/30 mb-6 card-hover ${
              ...
              <div className="bg-black/30 rounded-xl p-4 sm:p-5">
                ...
                <div className="flex justify-between items-center mb-3">
                  <span className="text-sky-400 font-black text-lg sm:text-xl">YOUR INVESTMENT:</span>
                  <span className="text-sky-400 font-black text-2xl sm:text-3xl">$47.82</span>
                </div>
            ...
            <div className={`bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-5 sm:p-10 text-center border-2 border-sky-500/50 shadow-2xl hover-glow ${
              ...
              <p className="text-sky-400 font-bold text-xs sm:text-base mb-4 sm:mb-6">Lifetime access • No monthly fees</p>

              <Link
                onClick={trackInitiateCheckout} href={WHOP_CHECKOUT_LINK}
                                className="w-full max-w-md mx-auto bg-gradient-to-r from-sky-500 via-amber-500 to-sky-500 text-white py-3.5 sm:py-5 rounded-xl font-black text-base sm:text-xl shadow-xl flex items-center justify-center gap-2 btn-press hover-glow animate-pulse-glow transition-transform"
              >
                <Zap className="w-4 h-4 sm:w-5 sm:h-5" />
                Get Instant Access Now
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 mt-4 sm:mt-6 text-gray-400 text-[10px] sm:text-sm">
                <div className="flex items-center gap-1">
                  <Shield className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-sky-400" />
                  <span>30-Day Guarantee</span>
                </div>
                <div className="flex items-center gap-1">
                  <CheckCircle className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-sky-400" />
                  <span>SSL Secured</span>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className={`text-center mb-6 sm:mb-10 ${visibleSections.has('faq') ? 'animate-fade-in-down' : ''}`}>
              <h2 className="text-2xl sm:text-4xl font-black text-gray-900 mb-2 sm:mb-4">
                Common <span className="text-sky-500">Questions</span>
              </h2>
            </div>
            ...
            <div className={`space-y-2 sm:space-y-3 stagger-children ${visibleSections.has('faq') ? 'visible' : ''}`}>
              {faqs.map((faq, i) => (
                <div
                  key={i}
                  className="bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl overflow-hidden hover:border-sky-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-sky-500/10"
                >
                  <button
                  ...
                  >
                    ...
                    <ChevronDown className={`w-4 h-4 sm:w-5 sm:h-5 text-sky-500 flex-shrink-0 transition-transform ${expandedFaq === i ? 'rotate-180' : ''}`} />
                  </button>
                  {expandedFaq === i && (
            ...
            <div className={`mt-8 sm:mt-12 text-center ${visibleSections.has('faq') ? 'animate-bounce-in animation-delay-500' : ''}`}>
              ...
              <a
                onClick={trackInitiateCheckout} href={WHOP_CHECKOUT_LINK}
                                className="group relative inline-flex items-center justify-center bg-gradient-to-r from-sky-500 via-amber-500 to-sky-500 text-white px-8 sm:px-12 py-4 sm:py-5 rounded-xl font-black text-base sm:text-xl btn-press hover-glow animate-pulse-glow transition-all shadow-2xl shadow-sky-500/30"
              >
                <span className="relative flex items-center gap-2 sm:gap-3 whitespace-nowrap">
          ...
          <div className="max-w-5xl mx-auto">
            <div className={`text-center mb-6 sm:mb-10 ${visibleSections.has('meet-instructor') ? 'animate-fade-in-up' : ''}`}>
              <div className="inline-flex items-center gap-2 bg-sky-500/10 border border-sky-500/30 px-3 py-1.5 rounded-full mb-3">
                ...
                <span className="text-sky-600 font-bold text-xs uppercase tracking-wide">Meet Your Expert</span>
              </div>
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-gray-900 mb-2 sm:mb-4">
                The Clinical Mind <span className="text-sky-500">Behind This System</span>
              </h2>
              <p className="text-gray-600 text-sm sm:text-lg max-w-2xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className={`space-y-4 ${visibleSections.has('reasons-why') ? 'animate-fade-in-up animation-delay-200' : ''}`}>
              {[
                ...
                <div key={i} className="flex gap-4 bg-white/5 border border-sky-500/20 rounded-xl p-4 sm:p-5">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-sky-500/20 rounded-full flex items-center justify-center flex-shrink-0">
                    <span className="text-sky-400 font-black text-sm sm:text-base">{item.num}</span>
                  </div>
                  <div>
            ...
            <div className={`mt-6 text-center ${visibleSections.has('reasons-why') ? 'animate-fade-in-up animation-delay-400' : ''}`}>
              <p className="text-sky-400 font-bold text-sm sm:text-base">
      ...
      >
        <div className="w-full px-3 sm:px-6">
          <div className="max-w-4xl mx-auto">
            <div className={`bg-gradient-to-br from-sky-500/5 via-white to-amber-500/5 border-2 border-sky-500/30 rounded-xl sm:rounded-2xl p-5 sm:p-10 relative overflow-hidden ${
              visibleSections.has('guarantee3') ? 'animate-fade-in-up' : ''
            }`}>
              {/* Decorative elements */}
              <div className="absolute top-0 right-0 w-40 h-40 bg-sky-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
              <div className="absolute bottom-0 left-0 w-40 h-40 bg-amber-500/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />

              <div className="relative z-10">
                <div className="text-center mb-5 sm:mb-8">
                  <div className="inline-flex items-center gap-2 bg-sky-500/20 border border-sky-500/40 rounded-full px-3 py-1.5 sm:px-4 sm:py-2 mb-3 sm:mb-4">
                    <Heart className="w-4 h-4 sm:w-5 sm:h-5 text-sky-500 animate-pulse" />
                    <span className="text-sky-600 font-bold text-xs sm:text-sm uppercase">Zero Risk Promise</span>
                  </div>
                  <h2 className="text-2xl sm:text-4xl font-black text-gray-900 mb-2">
                    Don't Love It? <span className="text-sky-500">Full Refund.</span>
                  </h2>
                ...
                <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-8 shadow-xl border border-gray-100">
                  <div className="flex flex-col md:flex-row items-center gap-4 sm:gap-8">
                    ...
                    <div className="relative flex-shrink-0">
                      <div className="w-24 h-24 sm:w-32 sm:h-32 relative">
                        <div className="absolute inset-0 rounded-full border-4 border-dashed border-sky-500/40 animate-spin-slow" />
                        <div className="absolute inset-2 rounded-full bg-gradient-to-br from-sky-500 via-amber-500 to-sky-500 shadow-2xl shadow-sky-500/30 flex flex-col items-center justify-center">
                          <div className="absolute inset-2 rounded-full bg-white flex flex-col items-center justify-center text-center p-2">
                            <Heart className="w-5 h-5 sm:w-7 sm:h-7 text-sky-500 mb-1" />
                            <span className="text-sky-600 font-black text-xs sm:text-sm leading-none">NO</span>
                        ...
                        <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 bg-gradient-to-r from-sky-500 to-amber-500 text-white font-bold text-[7px] sm:text-[9px] px-2.5 py-0.5 rounded-full shadow-lg whitespace-nowrap">
                          30 DAYS
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="mt-5 sm:mt-8 pt-5 sm:pt-6 border-t border-gray-100 text-center">
                    <p className="text-gray-900 font-bold text-sm sm:text-lg">
                      We only want happy customers. <span className="text-sky-500">Period.</span>
                    </p>
        ...
        <div className="w-full px-3 sm:px-6">
          <div className={`max-w-2xl mx-auto text-center ${visibleSections.has('final-cta') ? 'animate-fade-in-up' : ''}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 sm:mb-8">
              ...
              {/* Option 2 - Future */}
              <div className="bg-purple-50 rounded-xl p-4 sm:p-5 text-left border-2 border-sky-500">
                <div className="flex items-center gap-2 mb-3">
            ...
            <div className="bg-gray-100 rounded-xl p-4 sm:p-5 mb-4 sm:mb-6 text-left border border-gray-200">
              ...
              <div className="space-y-2 text-gray-600 text-sm">
                <p>• If Option 2 gets you <span className="font-bold text-gray-900">just 1 new client</span> in month 1... that's <span className="text-sky-600 font-bold">$2,000-5,000</span> from a $47.82 investment.</p>
                <p>• If you get <span className="font-bold text-gray-900">5 new clients</span> (average result)... that's <span className="text-sky-600 font-bold">$10,000-25,000</span> from $47.82.</p>
                <p>• Even if you try it for 30 days and ask for a refund... <span className="text-sky-600 font-bold">you're up $50</span> and lost nothing.</p>
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black rounded-xl sm:rounded-2xl p-4 sm:p-8 shadow-2xl mb-3 sm:mb-6">
              ...
              <div className="flex items-center justify-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                <span className="text-3xl sm:text-5xl font-black text-sky-400">$47.82</span>
                <div className="text-left">
              ...
              <Link
                onClick={trackInitiateCheckout} href={WHOP_CHECKOUT_LINK}
                                className="group relative w-full bg-gradient-to-r from-sky-400 via-amber-400 to-sky-400 text-black py-4 sm:py-5 rounded-xl font-black text-lg sm:text-xl flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98] transition-transform cursor-pointer overflow-hidden"
              >
      ...
      >
        <div className="w-full px-3 sm:px-6">
          <div className="max-w-2xl mx-auto">
            <div className={`bg-gradient-to-br from-white/5 to-white/[0.02] border border-sky-500/20 rounded-xl sm:rounded-2xl p-5 sm:p-8 ${visibleSections.has('still-thinking') ? 'animate-fade-in-up' : ''}`}>
              ...
              <div className="text-gray-400 text-sm sm:text-base leading-relaxed space-y-3 mb-6">
                ...
                <p className="text-sky-400 font-bold">You regret not trying it when you saw it.</p>
              </div>
              ...
              <div className="bg-black/30 rounded-xl p-4 sm:p-5 mb-6">
                ...
                <div className="grid grid-cols-3 gap-3 text-center">
                  <div>
                    <p className="text-sky-400 font-black text-lg sm:text-xl">$47.82</p>
                    <p className="text-gray-500 text-xs">Cost</p>
                  </div>
                  <div>
                    <p className="text-sky-400 font-black text-lg sm:text-xl">$0</p>
              ...
              <a
                onClick={trackInitiateCheckout} href={WHOP_CHECKOUT_LINK}
                                className="w-full bg-gradient-to-r from-sky-500 to-amber-500 text-white py-4 rounded-xl font-black text-base sm:text-lg flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98] transition-transform"
              >
                <Zap className="w-5 h-5" />
                Get Instant Access Now
                <ArrowRight className="w-5 h-5" />
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 sm:hidden bg-gradient-to-t from-black via-black/95 to-transparent pt-4 pb-safe">
        <div className="px-4 pb-4" style={{ paddingBottom: 'max(1rem, env(safe-area-inset-bottom))' }}>
          <a
            onClick={trackInitiateCheckout} href={WHOP_CHECKOUT_LINK}
                        className="w-full bg-gradient-to-r from-sky-500 to-amber-500 text-white py-4 rounded-xl font-black text-base flex items-center justify-center gap-2 shadow-2xl shadow-sky-500/30 active:scale-[0.98] transition-transform"
          >
      ...
      <div className={`fixed bottom-0 left-0 right-0 z-50 sm:hidden transition-all duration-300 ${
        ...
        <div className="bg-gradient-to-t from-black via-black/95 to-transparent pt-4 pb-4 px-4">
          <a
            href={WHOP_CHECKOUT_LINK}
            onClick={trackInitiateCheckout}
            className="flex items-center justify-center gap-2 w-full bg-gradient-to-r from-sky-500 to-amber-500 text-white py-4 rounded-xl font-black text-base shadow-2xl shadow-sky-500/30 animate-pulse"
          >
            <Zap className="w-5 h-5" />
