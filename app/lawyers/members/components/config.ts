...
export const BONUSES = [
  ...
  { id: 'bonus-2', name: '365-Day Legal Content Calendar', value: 397, icon: Calendar, description: 'Never run out of content ideas for a whole year', category: 'Planning', url: '/products/lawyer/bonuses/365-content-calendar.html', image: '/images/lawyer/social-templates.webp' },
  { id: 'bonus-3', name: 'The Retainer Closer Scripts', value: 597, icon: DollarSign, description: 'Convert more consultations into retained clients', category: 'Sales', url: '/products/lawyer/bonuses/retainer-closer-scripts.html', image: '/images/lawyer/consultation-scripts.webp' },
  { id: 'bonus-4', name: 'Authority Building Content System', value: 497, icon: Brain, description: 'Position yourself as THE go-to attorney in your area', category: 'Content', url: '/products/lawyer/bonuses/authority-building-system.html', image: '/images/lawyer/educational-content.webp' },
  ...
  { id: 'bonus-6', name: 'Fee Objection Destroyer Scripts', value: 447, icon: FileText, description: 'Handle fee objections with confidence and close more retainers', category: 'Sales', url: '/products/lawyer/bonuses/fee-objection-scripts.html', image: '/images/lawyer/insurance-scripts.webp' },
  ...
  { id: 'bonus-9', name: '5-Star Review Explosion System', value: 497, icon: Star, description: 'Get 20+ Google reviews every month on autopilot', category: 'Reviews', url: '/products/lawyer/bonuses/5-star-review-system.html', image: '/images/lawyer/review-explosion.webp' },
  { id: 'bonus-10', name: 'Case Win Marketing System', value: 597, icon: Users, description: 'Turn your case wins into a client attraction machine', category: 'Marketing', url: '/products/lawyer/bonuses/case-win-marketing.html', image: '/images/lawyer/group-legal.webp' },
]
