...
export default function PlasticAttorneyLandingPage() {
  ...
  useEffect(() => {
    ...
    const calculateTimeLeft = () => {
      ...
      // If deadline passed, show zeros (no fake reset)
      if (diff <= 0) {
  ...
  const allBonuses = LAWYER_BONUS_PRODUCTS
  const totalBonusValue = getLawyerTotalBonusValue()
    ...
    <main
      ...
      style={{
        background: `
          ...
          linear-gradient(135deg, #0a0a0f 0%, #0f0a0a 50%, #1a0f0a 100%)
        `
      }}
    >
      {/* Lawyer Theme Overrides - Gold/Amber + Modern 2025 Animations */}
      <style jsx global>{`
        /* ===== GOLD/AMBER BRANDING ===== */
        .lawyer-theme .text-gradient-premium {
          background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 50%, #d97706 100%);
          -webkit-background-clip: text;
          -webkit-text-fill-color: transparent;
          background-clip: text;
        }
        .lawyer-theme .btn-premium {
          background: linear-gradient(135deg, #d4af37 0%, #b8960c 100%);
          position: relative;
          overflow: hidden;
        }
        .lawyer-theme .btn-premium::before {
          content: '';
          position: absolute;
          top: 0;
          left: -100%;
        ...
        .lawyer-theme .btn-premium:hover::before {
          left: 100%;
        }
        .lawyer-theme .btn-premium:hover {
          box-shadow: 0 8px 25px rgba(212, 175, 55, 0.4), 0 4px 10px rgba(0, 0, 0, 0.1);
          transform: translateY(-2px);
        }
        .lawyer-theme .btn-premium:active {
          transform: translateY(0) scale(0.98);
        }
        .lawyer-theme .shadow-glow-gold {
          box-shadow: 0 0 30px rgba(212, 175, 55, 0.3), 0 0 60px rgba(212, 175, 55, 0.15);
        }
        .lawyer-theme .glass-gold {
          background: rgba(212, 175, 55, 0.08);
          border: 1px solid rgba(212, 175, 55, 0.15);
          backdrop-filter: blur(12px);
          -webkit-backdrop-filter: blur(12px);
        }
        .lawyer-theme .animate-pulse-glow {
        ...
        /* ===== SHADOW EFFECTS ===== */
        .shadow-premium-lg {
          box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 0 40px rgba(212, 175, 55, 0.1);
        }
        ...
        .stagger-fast.visible > *:nth-child(1) { animation-delay: 0ms; }
        .stagger-fast.visible > *:nth-child(2) { animation-delay: 50ms; }
        .stagger-fast.visible > *:nth-child(3) { animation-delay: 100ms; }
        .stagger-fast.visible > *:nth-child(4) { animation-delay: 150ms; }
        .stagger-fast.visible > *:nth-child(5) { animation-delay: 200ms; }
        .stagger-fast.visible > *:nth-child(6) { animation-delay: 250ms; }
      ...
      <AnimatedBackground variant="lawyer" />
      ...
      >
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(212, 175, 55, 0.15) 0%, rgba(245, 158, 11, 0.08) 25%, transparent 50%, rgba(245, 158, 11, 0.08) 75%, rgba(217, 119, 6, 0.12) 100%)',
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className={`relative max-w-5xl mx-auto mb-4 sm:mb-6 ${visibleSections.has('hero') ? 'animate-scale-in animation-delay-300' : ''}`}>
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden glass-premium shadow-premium-lg hover-lift img-zoom">
                ...
                <Image
                  src="/images/lawyer/attorney-hero-mobile.webp"
                  alt="AI Video System for Lawyers Showcase"
                  width={640}
                  height={358}
                ...
                <Image
                  src="/images/lawyer/attorney-hero.webp"
                  alt="AI Video System for Lawyers Showcase"
                  width={1365}
                  height={768}
            ...
            <div className={`flex flex-wrap items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8 stagger-fast ${visibleSections.has('hero') ? 'visible' : ''}`}>
              ...
              <div className="flex items-center gap-1.5 glass-gold px-4 py-2.5 rounded-full hover-scale">
                {[...Array(5)].map((_, i) => (
      ...
      >
        ...
        <div className="w-full px-3 sm:px-6 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            {/* Testimonial from international attorney */}
            <div className="bg-gradient-to-r from-amber-500/10 to-yellow-500/10 border border-amber-500/20 rounded-xl sm:rounded-2xl p-4 sm:p-6">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-amber-500 to-yellow-500 flex items-center justify-center text-white text-sm sm:text-xl font-bold">
                    CS
                  </div>
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className="w-3 h-3 sm:w-4 sm:h-4 text-yellow-400 fill-amber-400" />
                      ))}
                    </div>
                  ...
                  <p className="text-white text-xs sm:text-base leading-relaxed mb-2 sm:mb-3">
                    "The Portuguese accent is <span className="text-amber-400 font-semibold">perfect</span> — my clients can't tell it's AI. Case requests tripled. <span className="text-yellow-400 font-semibold">Worth every penny.</span>"
                  </p>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/3 right-20 w-3 h-3 bg-yellow-500/20 rounded-full animate-pulse" />
      ...
      {/* ================================================================
          ...
          "He booked $156K in cases in 8 weeks"
          ================================================================ */}
      <section
        id="case-study"
        data-animate
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className={`text-center mb-8 sm:mb-12 relative z-10 ${visibleSections.has('case-study') ? 'animate-fade-in-down' : ''}`}>
              <div className="inline-flex items-center gap-2 bg-amber-500/20 border border-amber-500/40 px-4 py-2 rounded-full mb-4 hover-scale">
                ...
                <span className="text-amber-700 font-bold text-xs uppercase tracking-wide">Real Results • Board-Certified Attorney</span>
              </div>
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-gray-900 mb-3 sm:mb-4 leading-tight">
                Dr. Daniel Booked <span className="text-amber-600">$156K in Cases</span>...
              </h2>
            ...
            <div className={`relative bg-gradient-to-br from-zinc-900 via-black to-zinc-900 border border-amber-500/20 rounded-2xl sm:rounded-3xl overflow-hidden card-hover ${visibleSections.has('case-study') ? 'animate-scale-in animation-delay-200' : ''}`}>
                  ...
                  {visibleSections.has('case-study') ? (
                    <>
                      ...
                      <video
                        ...
                        muted
                        playsInline
                        poster="/images/lawyer/dr-marcus.webp"
                        className="w-full h-full object-contain sm:hidden"
                        src="/videos/lawyer-daniel-mobile.mp4"
                      />
                      ...
                      <video
                        ...
                        src="/videos/lawyer-daniel.mp4"
                      />
                    </>
                  ) : (
                    <Image
                      src="/images/lawyer/dr-marcus.webp"
              ...
              {/* Results Strip */}
              <div className="bg-gradient-to-r from-amber-500/20 via-yellow-500/20 to-amber-500/20 border-y border-amber-500/30 py-4 px-4 sm:px-8">
                <div className="grid grid-cols-3 gap-4 text-center">
                  {[
                    { number: '28', label: 'Cases', sub: 'in 4 weeks' },
              ...
              <div className="p-4 sm:p-8 border-t border-white/10">
                ...
                <div className="space-y-3 sm:space-y-4">
                  {[
                    ...
                    { time: 'Week 1', event: 'Video hit 47K views • 12 case requests', icon: Phone, color: 'gold' },
                    { time: 'Week 2', event: '3 rhinoplasties booked ($24K avg each = $72K)', icon: Calendar, color: 'gold' },
                    { time: 'Week 4', event: '28 total cases • 9 surgeries scheduled', icon: FileText, color: 'gold' },
                    { time: 'Week 8', event: '$156,000 in new case revenue', icon: DollarSign, color: 'green' },
                  ].map((item, i) => (
                    <div key={i} className="flex items-start gap-3">
                      <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                        item.color === 'green' ? 'bg-green-500/20 border border-green-500/40' :
                        item.color === 'gold' ? 'bg-amber-500/20 border border-amber-500/40' :
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-white text-lg sm:text-xl font-medium italic leading-relaxed mb-4">
                      ...
                      <span className="text-amber-400 font-bold"> 28 qualified cases in 4 weeks</span> — clients who already trusted me before walking in.
              ...
              <div className="grid grid-cols-3 divide-x divide-white/10 bg-black/50">
                {[
                  ...
                  { value: '28', label: 'Cases', sub: '4 weeks' },
        ...
        <div className="w-full px-3 sm:px-6 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-amber-500 via-yellow-500 to-green-500 -translate-y-1/2 rounded-full opacity-20" />
              ...
              <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 stagger-children ${visibleSections.has('how-it-works') ? 'visible' : ''}`}>
                ...
                <div className="group relative">
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-5 sm:p-6 border-2 border-gray-100 hover:border-amber-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-amber-500/10 h-full hover-lift">
                    ...
                    <div className="absolute -top-3 -left-2 sm:-top-4 sm:-left-3">
                      <div className="relative">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-amber-500 to-yellow-500 rounded-xl flex items-center justify-center shadow-lg shadow-amber-500/30 group-hover:scale-110 transition-transform">
                    ...
                    {/* Icon */}
                    <div className="w-14 h-14 bg-gradient-to-br from-amber-500/20 to-yellow-500/10 rounded-xl flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
                ...
                <div className="group relative">
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-5 sm:p-6 border-2 border-gray-100 hover:border-yellow-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-yellow-500/10 h-full hover-lift">
                    {/* Step number */}
                    <div className="absolute -top-3 -left-2 sm:-top-4 sm:-left-3">
                      <div className="relative">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-yellow-500 to-amber-500 rounded-xl flex items-center justify-center shadow-lg shadow-yellow-500/30 group-hover:scale-110 transition-transform">
                    ...
                    {/* Time badge */}
                    <div className="flex justify-end mb-4 mt-2">
                      <span className="bg-yellow-500/10 text-yellow-600 px-3 py-1 rounded-full text-xs font-bold border border-yellow-500/20">
                        3 min
                      </span>
                    </div>

                    {/* Icon */}
                    <div className="w-14 h-14 bg-gradient-to-br from-yellow-500/20 to-amber-500/10 rounded-xl flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-5 sm:p-6 border-2 border-gray-100 hover:border-amber-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-amber-500/10 h-full hover-lift">
                    ...
                    <div className="absolute -top-3 -left-2 sm:-top-4 sm:-left-3">
                      <div className="relative">
                        ...
                        <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-gradient-to-r from-amber-500 to-yellow-500 rounded-full flex items-center justify-center">
            ...
            <div className={`flex justify-center mt-8 sm:mt-12 ${visibleSections.has('how-it-works') ? 'animate-fade-in-up animation-delay-500' : ''}`}>
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-amber-500 to-yellow-500 rounded-full blur-xl opacity-20 animate-pulse" />
                <div className="relative flex items-center gap-4 sm:gap-6 bg-gradient-to-r from-gray-900 to-gray-800 rounded-full px-6 sm:px-10 py-3 sm:py-4 shadow-2xl">
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-yellow-400 font-black text-2xl sm:text-4xl">~20</span>
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3">
                      <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                        ...
                        item.color === 'gold' ? 'bg-amber-100 border border-amber-500/40' :
                        'bg-gray-100 border border-gray-300'
                      }`}>
                        <item.icon className={`w-4 h-4 sm:w-5 sm:h-5 ${
                          item.color === 'green' ? 'text-green-600' :
                          item.color === 'gold' ? 'text-amber-600' :
                          'text-gray-500'
                        }`} />
                      </div>
                      <div className="flex-1 min-w-0">
                        <span className={`inline-block text-[10px] sm:text-xs font-black px-2 py-0.5 rounded mb-1 ${
                          ...
                          item.color === 'gold' ? 'bg-amber-100 text-amber-600' :
        ...
        <div className="w-full px-3 sm:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className={`text-center mb-6 sm:mb-8 ${visibleSections.has('case-study-lisa') ? 'animate-fade-in-up' : ''}`}>
              <div className="inline-flex items-center gap-2 bg-yellow-500/10 border border-yellow-500/30 px-3 py-1.5 rounded-full mb-3">
                <TrendingUp className="w-3.5 h-3.5 text-yellow-400" />
                <span className="text-yellow-400 font-bold text-xs uppercase tracking-wide">Rhinoplasty Success Story</span>
              </div>
              <h2 className="text-2xl sm:text-4xl font-black text-white mb-2">
                One Video. <span className="text-yellow-400">23 Legal Cases.</span>
              </h2>
              <p className="text-gray-400 text-sm sm:text-lg">From skeptic to booked solid in 30 days</p>
            </div>

            {/* Dr. Lisa Case Study Card */}
            <div className={`bg-gradient-to-br from-white/10 to-white/5 border border-yellow-500/30 rounded-xl sm:rounded-2xl overflow-hidden ${visibleSections.has('case-study-lisa') ? 'animate-fade-in-up animation-delay-200' : ''}`}>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                {/* Left: Image - Mobile optimized */}
                <div className="relative aspect-video lg:aspect-auto">
                  {/* Mobile: 22KB optimized image */}
                  <Image
                    src="/images/lawyer/case-study-rhinoplasty-mobile.webp"
                    alt="Dr. Lisa Park - Rhinoplasty Case AI Video"
                    fill
                  ...
                  {/* Desktop: Full quality image */}
                  <Image
                    src="/images/lawyer/case-study-rhinoplasty.webp"
                    alt="Dr. Lisa Park - Rhinoplasty Case AI Video"
                    fill
                  ...
                  <div className="absolute bottom-3 left-3 bg-black/80 backdrop-blur-sm px-3 py-1.5 rounded-lg">
                    <span className="text-yellow-400 text-xs font-bold">89K Views on TikTok</span>
                  </div>
                </div>
                ...
                <div className="p-5 sm:p-8 flex flex-col justify-center">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-yellow-500 bg-gradient-to-br from-yellow-500 to-orange-600 flex items-center justify-center">
                      <span className="text-white font-bold text-sm">LP</span>
                    </div>
                    <div>
                      <h3 className="text-white font-bold text-lg">Dr. Lisa Park</h3>
                      <p className="text-yellow-400 text-sm">Relationship & Family Attorney • Seattle, WA</p>
                    </div>
                  </div>
                  ...
                  <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4 italic">
                    ...
                    I booked <span className="text-yellow-400 font-bold">23 new cases</span> that month.
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    {[
                      ...
                      { value: '23', label: 'Consultations' },
                      { value: '$276K', label: 'Revenue' },
                    ].map((stat, i) => (
                      <div key={i} className="bg-black/40 rounded-lg p-3 text-center border border-white/10">
                        <div className={`text-lg sm:text-xl font-black ${i === 2 ? 'text-green-400' : 'text-yellow-400'}`}>{stat.value}</div>
                  ...
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-amber-400 text-yellow-400" />
                    ))}
      ...
      >
        ...
        <div className="testimonial-carousel-wrapper-lawyer">
          <div className="testimonial-scroll-track-lawyer">
            {/* First set of testimonials */}
            {testimonials.map((t) => (
              <div key={`first-${t.id}`} className="testimonial-card-lawyer">
                {/* Quote Icon */}
                <div className="testimonial-quote-icon-lawyer">
            ...
            {testimonials.map((t) => (
              <div key={`second-${t.id}`} className="testimonial-card-lawyer">
                {/* Quote Icon */}
                <div className="testimonial-quote-icon-lawyer">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10 8H6C4.89543 8 4 8.89543 4 10V14C4 15.1046 4.89543 16 6 16H8C9.10457 16 10 15.1046 10 14V8ZM10 8C10 5.79086 8.20914 4 6 4" stroke="white" strokeWidth="2" strokeLinecap="round"/>
            ...
            <div className={`bg-gradient-to-br from-amber-500/10 to-white border-2 border-amber-500/40 rounded-xl sm:rounded-2xl p-5 sm:p-10 relative overflow-hidden ${
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-4 mt-6 sm:mt-8">
                  {[
                    { icon: CalendarCheck, title: 'Risk-Free', desc: 'Try for 30 days' },
                    { icon: Shield, title: 'Full Refund', desc: 'No questions asked' },
                  ].map((item, i) => (
        ...
        <div className="w-full px-3 sm:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className={`${visibleSections.has('meet-instructor') ? 'animate-fade-in-up animation-delay-200' : ''}`}>
              <ExpertPersona {...ALEX_VOSS_LAWYER_DATA} />
            </div>
      ...
      >
        <div className="w-full px-3 sm:px-6">
          <div className="max-w-4xl mx-auto">
            <div className={`bg-gradient-to-br from-amber-500/5 via-white to-yellow-500/5 border-2 border-amber-500/30 rounded-xl sm:rounded-2xl p-5 sm:p-10 relative overflow-hidden ${
      ...
      <style jsx global>{`
        /* Override global text-gradient-premium for lawyer (gold theme) */
        ...
        /* Override glass-gold for gold theme */
        .glass-gold {
          background: rgba(212, 175, 55, 0.08) !important;
          border: 1px solid rgba(212, 175, 55, 0.2) !important;
        }

        /* Override shadow-glow-gold for gold theme */
        .shadow-glow-gold {
          box-shadow: 0 0 20px rgba(212, 175, 55, 0.3), 0 0 40px rgba(212, 175, 55, 0.1) !important;
        }

        /* Lawyer background gradient */
        .bg-animated-gradient-lawyer {
          background: linear-gradient(135deg, #000000 0%, #0f0a05 50%, #000000 100%);
        }
        ...
        /* Testimonial carousel styles for lawyer - MOBILE OPTIMIZED */
        .testimonial-carousel-wrapper-lawyer {
          position: relative;
          overflow: hidden;
          width: 100%;
        ...
        .testimonial-scroll-track-lawyer {
          display: flex;
          gap: 0.75rem;
          animation: scroll-lawyer 35s linear infinite;
          width: fit-content;
          padding: 0.5rem 0;
        }

        .testimonial-card-lawyer {
          flex-shrink: 0;
          width: 280px;
        ...
        .testimonial-quote-icon-lawyer svg {
          width: 100%;
          height: 100%;
          max-width: 20px;
          max-height: 20px;
        ...
        @media (max-width: 480px) {
          ...
          .testimonial-carousel-wrapper-lawyer:hover .testimonial-scroll-track-lawyer,
          .testimonial-carousel-wrapper-lawyer:focus-within .testimonial-scroll-track-lawyer {
