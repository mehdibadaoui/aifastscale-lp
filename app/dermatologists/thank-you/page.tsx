...
function ThankYouContent() {
  ...
  useEffect(() => {
    const visited = sessionStorage.getItem('dermatologist_thankyou_visited')
    if (visited) {
      setHasVisited(true)
    }
  }, [])
  ...
  const fetchCredentials = useCallback(async (email?: string, userId?: string) => {
    try {
      ...
      const response = await fetch(`/api/dermatologist-credentials?${params.toString()}`)
  ...
  useEffect(() => {
    const startPolling = async () => {
      const storedEmail = sessionStorage.getItem('dermatologist_purchase_email')
      const storedUserId = sessionStorage.getItem('dermatologist_purchase_user_id')
  ...
  const handleLoginClick = () => {
    ...
    sessionStorage.setItem('dermatologist_thankyou_visited', 'true')
  ...
  if (hasVisited) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1f0f1a] to-[#2a1a1e] flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1f0f1a] to-[#2a1a1e]">
      <div className="container mx-auto px-4 py-8 md:py-12 max-w-2xl">
        ...
        <div className="text-center mb-8">
          <div className="relative inline-block mb-6">
            ...
            <div className="relative w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-rose-500 to-pink-500 flex items-center justify-center shadow-lg shadow-rose-500/30">
          ...
          <p className="text-xl md:text-2xl font-bold text-rose-400 mb-4">
            Payment Successful
          </p>
        ...
        {/* LOADING STATE */}
        {isLoading && (
          <div className="rounded-2xl bg-gradient-to-br from-rose-500/20 via-rose-500/10 to-transparent border border-rose-500/30 p-8 backdrop-blur-sm text-center">
        ...
        {credentials && !isLoading && (
          <>
            {/* Login Card */}
            <div className="rounded-2xl bg-gradient-to-br from-rose-500/20 via-rose-500/10 to-transparent border border-rose-500 p-6 md:p-8 backdrop-blur-sm mb-6">
              ...
              {/* Credentials Box */}
              <div className="bg-[#0a0a0a]/80 rounded-xl p-5 mb-6 border border-rose-500/30">

                {/* Email */}
                <div className="mb-4">
                  <p className="text-rose-400 text-xs font-semibold uppercase tracking-wider mb-2">Email</p>
                ...
                {/* Password */}
                <div>
                  <p className="text-rose-400 text-xs font-semibold uppercase tracking-wider mb-2">Password</p>
                  <div className="bg-white/5 rounded-lg px-4 py-3 border border-rose-500/50 flex items-center justify-between gap-3">
                  ...
                  <div key={i} className="flex flex-col items-center text-center flex-1">
                    <div className={`w-11 h-11 rounded-full flex items-center justify-center mb-2 transition-all ${
                      step.active
                        ...
                        : i < (copiedPassword ? 2 : 1) ? 'bg-rose-500/70' : 'bg-white/10'
                    }`}>
            ...
            <div className="mt-6 rounded-xl bg-gradient-to-r from-emerald-500/20 to-rose-500/20 border border-emerald-500/30 p-4 text-center">
        ...
        {showFallback && !credentials && !isLoading && (
          <>
            <div className="rounded-2xl bg-gradient-to-br from-rose-500/20 via-rose-500/10 to-transparent border border-rose-500 p-6 md:p-8 backdrop-blur-sm mb-6 text-center">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-rose-500 to-pink-500 text-white font-bold text-lg py-4 rounded-xl flex items-center justify-center gap-2"
              >
                <Zap className="w-5 h-5" />
                Go to Login Page
                <ArrowRight className="w-5 h-5" />
                ...
                {[
                  ...
                  <div key={i} className="flex flex-col items-center text-center flex-1">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center mb-1 ${
                      i === 0 ? 'bg-rose-500' : i === 1 ? 'bg-rose-500/60' : 'bg-rose-500/30'
                    }`}>
        ...
        <p className="text-center text-white/40 text-sm mt-8">
          ...
          <a href="mailto:support@aifastscale.com" className="text-rose-400 hover:underline">
...
export default function DermatologistThankYouPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1f0f1a] to-[#2a1a1e] flex items-center justify-center">
        <Loader2 className="w-8 h-8 text-rose-500 animate-spin" />
