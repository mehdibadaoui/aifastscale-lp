...
export const COURSE_MODULES = [
  {
    id: 'module-1',
    number: 1,
    title: 'Scriptwriting with Your Dermatologist AI Mentor',
    description: "Learn how to use your personalized Dermatologist AI mentor to generate high-quality short-form video scripts, story ideas, and content plans in minutes.",
    duration: '3 min',
    durationMinutes: 3,
    wistiaId: 'myh13ayp9d',
    thumbnail: '/images/dentist/module-1-scriptwriting.webp',
    lessons: ['Write video scripts in minutes', 'Using Dermatologist Expert Copywriter AI', 'Get scripts for trust & bookings'],
    resources: [
      { name: 'Dermatologist Expert Copywriter GPT', url: 'https://chatgpt.com/g/g-693ff08b15208191b94265efd521f783-dentist-expert-copywriter', type: 'link' as const },
    ],
  },
  {
    id: 'module-2',
