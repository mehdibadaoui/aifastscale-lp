...
export function CertificateModal({ isOpen, onClose, studentName, completionDate }: CertificateModalProps) {
  ...
  const handleShare = (platform: 'twitter' | 'linkedin') => {
    ...
    const url = 'https://aifastscale.com/dermatologists'
  ...
  const steps = [
    {
      ...
      description: "You've just unlocked exclusive access to the most comprehensive AI course for dermatology practices.",
      icon: 'welcome',
