...
// Import all icons - tree-shaking handles the rest
import {
  Gift, Shield, CheckCircle, ArrowRight, Clock, Users, Video, Upload,
  TrendingUp, Play, ChevronDown, Star, Check, X, AlertTriangle, Zap,
  Crown, MapPin, Award, DollarSign, VolumeX, Eye, Heart, ThumbsUp,
  RefreshCw, MessageSquare, Calendar, CalendarCheck, FileText,
  Stethoscope, Phone, Mail, Send, Smile
} from 'lucide-react'

// Static imports for critical data
...
// Lazy load heavy components - won't block initial paint
const ExpertPersona = dynamic(
  () => import('../components/ExpertPersona').then(m => ({ default: m.ExpertPersona })),
  { ssr: false, loading: () => <div className="h-96 bg-gray-100/50 rounded-2xl" /> }
)
...
const CHECKOUT_LINK = '/dermatologists/checkout'

export default function DermatologistCleanLandingPage() {
  const [timeLeft, setTimeLeft] = useState({ days: 0, hours: 0, minutes: 0, seconds: 0 })
  const [expandedFaq, setExpandedFaq] = useState<number | null>(null)
  const [isVideoPlaying, setIsVideoPlaying] = useState(false)
  const [isVideoMuted, setIsVideoMuted] = useState(true)
  // Static initial values - prevents JS execution during initial paint
  ...
  const [visibleSections, setVisibleSections] = useState<Set<string>>(new Set(['hero', 'economics-case-studies', 'case-study', 'whats-inside', 'how-it-works', 'pricing', 'faq', 'guarantee', 'guarantee1', 'guarantee2', 'guarantee3', 'meet-instructor', 'reasons-why', 'testimonials', 'final-cta', 'still-thinking']))

  // Update member stats AFTER page is interactive
  useEffect(() => {
    // Only calculate real stats after 2 seconds - doesn't affect initial load
    const timeout = setTimeout(() => {
      setMemberStats(getMemberStats())
    }, 2000)

    const interval = setInterval(() => setMemberStats(getMemberStats()), 60000)
  ...
  return (
    <main className="min-h-screen bg-gradient-premium noise-overlay font-sans relative">
      ...
      <AnimatedBackground variant="dermatologist" />
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className={`mb-5 sm:mb-8 ${(!isMobile && visibleSections.has('hero')) ? 'animate-fade-in-up animation-delay-250' : ''}`}>
              <div className="inline-flex items-center gap-2 badge-premium badge-glow">
                ...
                <span className="text-teal-300 font-semibold text-xs sm:text-sm">Dr. Alexander Voss, MD</span>
              </div>
            </div>
      ...
      {/* ================================================================
          ECONOMICS OF ZERO-EFFORT CONTENT - TWO SIDE-BY-SIDE CASE STUDIES
          ================================================================ */}
      <section
        id="economics-case-studies"
        data-animate
      ...
      >
        ...
        <div className="w-full px-3 sm:px-6">
          ...
          <div className="max-w-6xl mx-auto mt-10 sm:mt-16">
            <div className={`text-center mb-8 sm:mb-12 relative z-10 ${(!isMobile && visibleSections.has('economics-case-studies')) ? 'animate-fade-in-up' : ''}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className={`relative bg-gradient-to-br from-zinc-900 via-black to-zinc-900 border border-teal-500/20 rounded-2xl sm:rounded-3xl overflow-hidden ${(!isMobile && visibleSections.has('economics-case-studies')) ? 'animate-scale-in animation-delay-200' : ''}`}>
              ...
              <div className={`relative bg-gradient-to-br from-zinc-900 via-black to-zinc-900 border border-teal-500/20 rounded-2xl sm:rounded-3xl overflow-hidden ${(!isMobile && visibleSections.has('economics-case-studies')) ? 'animate-scale-in animation-delay-400' : ''}`}>
                <div className="absolute inset-0 bg-gradient-to-br from-teal-500/5 via-transparent to-teal-500/5 pointer-events-none" />
              ...
              <div className="p-4 sm:p-8">
                ...
                <div className="mt-4 pt-4 border-t border-white/10">
                  <p className="text-gray-400 text-xs sm:text-sm flex items-center gap-2">
                    ...
                    <span>Clinically-structured lessons and examples created with input from <span className="text-teal-400 font-medium">Dr. Alexander Voss</span>, Aesthetic and Restorative Dermatologist</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className={`text-center mb-8 sm:mb-14 ${(!isMobile && visibleSections.has('how-it-works')) ? 'animate-fade-in-up' : ''}`}>
              ...
              <p className="text-gray-600 text-sm sm:text-lg max-w-2xl mx-auto">
                Even if you've never touched AI before. Works <span className="font-bold text-gray-800">only for dermatologists</span>.
              </p>
            </div>
                ...
                <div className={`group relative ${(!isMobile && visibleSections.has('how-it-works')) ? 'animate-fade-in-up' : ''}`} style={{ animationDelay: '0ms' }}>
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-5 sm:p-6 border-2 border-gray-100 hover:border-teal-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-teal-500/10 h-full">
                    ...
                    <p className="text-gray-500 text-sm leading-relaxed">
                      Use our <span className="text-teal-600 font-semibold">ChatGPT specialist</span> built for dermatology practices. Just describe your topic.
                    </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
                  ...
                  <div className="flex items-center gap-4 sm:flex-col sm:items-center sm:text-center">
                    ...
                    <div className="sm:mt-2">
                      ...
                      <p className="text-teal-600 text-sm font-medium">Cosmetic Dermatologist</p>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      "I was spending <span className="text-gray-900 font-bold">$2,000 every month</span> on dermatology marketing agencies.
                      After 6 months, I had <span className="text-gray-900 font-bold">$12,000 spent</span> and
                      <span className="text-red-600 font-bold"> only 3 cosmetic treatment consultations</span>. Meanwhile, younger dermatologists were
      ...
      >
        ...
        <div className="testimonial-carousel-wrapper-dermatologist">
          <div className="testimonial-scroll-track-dermatologist">
            {/* First set of testimonials */}
            {testimonials.map((t) => (
              <div key={`first-${t.id}`} className="testimonial-card-dermatologist">
                {/* Quote Icon */}
                <div className="testimonial-quote-icon-dermatologist">
            ...
            {testimonials.map((t) => (
              <div key={`second-${t.id}`} className="testimonial-card-dermatologist">
                {/* Quote Icon */}
                <div className="testimonial-quote-icon-dermatologist">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10 8H6C4.89543 8 4 8.89543 4 10V14C4 15.1046 4.89543 16 6 16H8C9.10457 16 10 15.1046 10 14V8ZM10 8C10 5.79086 8.20914 4 6 4" stroke="white" strokeWidth="2" strokeLinecap="round"/>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className={`bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-5 sm:p-8 border border-teal-500/30 mb-6 ${
              ...
              <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                ...
                {/* Bonuses */}
                <div className="flex justify-between items-center py-2 border-b border-white/10">
                  <span className="text-gray-300 text-sm sm:text-base">100 Viral Dermatology Video Scripts</span>
                ...
                <div className="flex justify-between items-center py-2 border-b border-white/10">
                  <span className="text-gray-300 text-sm sm:text-base">Dermatology Profit Simulator</span>
      ...
      >
        <div className="w-full px-3 sm:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="sr-only">
              Dr. Alexander Voss is an aesthetic and restorative dermatologist with over 12 years of experience in Botox/fillers, skin rejuvenation, cosmetic dermatology, and advanced skin treatments. He has helped dermatologists across 15+ countries attract high-value cosmetic patients.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className={`space-y-4 ${(!isMobile && visibleSections.has('reasons-why')) ? 'animate-fade-in-up animation-delay-200' : ''}`}>
              {[
                ...
                },
                {
                  ...
                  desc: 'Unlike software companies that need recurring revenue, my success comes from helping dermatologists succeed. When you win, I win. So I price based on value delivered, not what I can get away with.',
                },
                {
                  num: '3',
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 sm:mb-8">
              ...
              <div className="bg-gray-100 rounded-xl p-4 sm:p-5 text-left border border-gray-200">
                ...
                <div className="space-y-2 text-gray-600 text-xs sm:text-sm">
                  ...
                  <p>→ You watch TikTok dermatologists book patients</p>
      ...
      <style jsx global>{`
        /* Dermatologist-specific background gradient */
        .bg-animated-gradient-dermatologist {
          background: linear-gradient(135deg, #000000 0%, #0f172a 50%, #000000 100%);
        }

        .bg-particles-dermatologist {
          position: fixed;
          top: 0;
          left: 0;
          width: 100%;
        ...
        /* Testimonial carousel styles for dermatologist - MOBILE OPTIMIZED */
        .testimonial-carousel-wrapper-dermatologist {
          position: relative;
          overflow: hidden;
          width: 100%;
        ...
        .testimonial-scroll-track-dermatologist {
          display: flex;
          gap: 0.75rem;
          animation: scroll-dermatologist 35s linear infinite;
          width: fit-content;
          padding: 0.5rem 0;
        }

        .testimonial-card-dermatologist {
          flex-shrink: 0;
          width: 280px;
        ...
        .testimonial-quote-icon-dermatologist {
          position: absolute;
          top: 0.75rem;
          right: 0.75rem;
          width: 20px;
        ...
        .testimonial-quote-icon-dermatologist svg {
          width: 100%;
          height: 100%;
          max-width: 20px;
          max-height: 20px;
        ...
        @keyframes scroll-dermatologist {
          0% {
