...
const modules: CourseModule[] = [
  {
    ...
    lessons: [
      'Create your Google Flow account',
      'Navigate the Flow dashboard',
      'Upload your first avatar photo',
      'Generate your AI clone with Veo 3.1',
    ],
    resources: [
      { name: 'Google Flow (Veo 3.1)', url: 'https://labs.google/fx/tools/flow', type: 'link' },
    ],
  },
  {
    id: 'module-2',
...
const bonuses: Bonus[] = [
  {
    ...
    category: 'Scripts',
    url: '/bonuses/100-viral-video-scripts.md',
  ...
  },
  {
    ...
    category: 'Templates',
    url: '/bonuses/case-studies-vault.md',
  ...
  },
  {
    ...
    category: 'Templates',
    url: '/bonuses/365-content-planner.md',
  ...
  },
  {
    ...
    category: 'Tools',
    url: '/bonuses/5-star-review-system.md',
  ...
  },
  {
    ...
    category: 'Tools',
    url: '/bonuses/ai-content-generator-prompts.md',
  ...
  },
  {
    ...
    category: 'Templates',
    url: '/bonuses/before-after-system.md',
  ...
  },
  {
    ...
    category: 'Scripts',
    url: '/bonuses/phone-scripts-that-book.md',
  ...
  },
  {
    ...
    category: 'Tools',
    url: '/bonuses/referral-machine-system.md',
  ...
  },
  {
    ...
    category: 'Scripts',
    url: '/bonuses/turn-no-into-yes.md',
  ...
  },
  {
    ...
    category: 'Tools',
    url: '/bonuses/offer-funnel-blueprint.md',
