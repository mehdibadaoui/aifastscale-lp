...
export const dermatologistsConfig: NicheConfig = {
  ...
  modules: [
    ...
    },
    {
      ...
      description: 'Create stunning before/after content that showcases your work and attracts high-value cosmetic dermatology patients.',
      duration: '5 min',
      durationMinutes: 5,
      wistiaId: null,
      thumbnail: null,
    ...
    },
    {
      ...
      description: 'Create educational videos about skin treatments that position you as the expert and drive bookings.',
      duration: '7 min',
      durationMinutes: 7,
      wistiaId: null,
      thumbnail: null,
      lessons: ['Treatment explainers', 'FAQ video series', 'Treatment option comparisons'],
      comingSoon: true,
      resources: [],
    },
    {
      ...
      description: 'Master TikTok, Instagram Reels, YouTube Shorts, and Facebook with dermatology-specific strategies.',
      duration: '8 min',
      durationMinutes: 8,
      wistiaId: null,
      thumbnail: null,
