...
export const dentistsConfig: NicheConfig = {
  // Identity
  slug: 'dentists',
  title: 'CloneYourself',
  ...
  modules: [
    {
      ...
      resources: [
        { name: 'Dentist Expert Copywriter GPT', url: 'https://chatgpt.com/g/g-693ff08b15208191b94265efd521f783-dentist-expert-copywriter', type: 'link' },
      ],
    },
    {
      id: 'module-2',
  ...
  auth: {
    product: 'dentist',
    legacyPassword: 'dentist2026',
    legacyEnabled: true,
    vipGuests: [
      {
        id: 'matias-gaete',
        name: 'Matías Gaete',
        password: 'VIPdentist2024',
        welcomeMessage: 'Welcome, Matías! Enjoy your VIP access.',
        badge: 'VIP Guest',
      },
      {
        id: 'whop-reviewer',
        name: 'Whop Reviewer',
        password: 'WhopReview2024',
        welcomeMessage: 'Welcome, Whop Reviewer! We hope you enjoy the platform.',
        badge: 'Reviewer',
      },
    ],
    whopCheckoutLink: '#',
