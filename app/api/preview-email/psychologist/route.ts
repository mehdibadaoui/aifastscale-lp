...
/**
 * Preview route for Psychologist Welcome Email
 * Visit: /api/preview-email/psychologist
 * This shows how the email will look for psychologist/therapist customers
 */
...
export async function GET() {
  ...
  // Sky blue branding for psychologists
  const accent = '#0ea5e9' // Sky blue
  const buttonColor = '#0ea5e9'
  const glowColor = 'rgba(14, 165, 233, 0.08)'
  const socialProof = 'Trusted by <strong style="color: #0ea5e9;">+750 psychologists & therapists</strong> worldwide'
