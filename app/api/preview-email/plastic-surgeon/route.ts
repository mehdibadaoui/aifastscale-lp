...
/**
 * Preview route for Plastic Surgeon Welcome Email
 * Visit: /api/preview-email/plastic-surgeon
 * This shows how the email will look for plastic surgeon customers
 */
...
export async function GET() {
  const userEmail = 'dr.smith@example.com'
