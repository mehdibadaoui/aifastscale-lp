      ...
      line_items: [
        {
          price_data: {
            currency: 'usd',
            product_data: {
              name: '$10M Personal Brand Blueprint (2026 Edition)',
              description:
                'The complete 5-week system to build a $10M personal brand using AI - For Real Estate Agents',
              images: [
                'https://aifastscale.com/images/blueprint-cover.jpg', // You can update this URL later
              ],
            },
            unit_amount: amount * 100, // $17 or $7 in cents
          },
          quantity: 1,
        },
      ],
