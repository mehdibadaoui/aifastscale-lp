            ...
            <div className="space-y-6 text-center md:space-y-8">
              ...
              <div className="flex flex-col items-center gap-4 px-2 pt-4 md:gap-6">
                ...
                >
                  ...
                  <div
                    className={`relative flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-green-500 via-green-400 to-green-500 px-6 py-4 text-base font-black tracking-wider text-white uppercase shadow-2xl transition-transform duration-300 active:scale-95 md:gap-3 md:px-10 md:py-5 md:text-xl ${priceUnlocked ? 'pump-animation' : ''}`}
                  >
