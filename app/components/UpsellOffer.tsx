...
export default function UpsellOffer({
  ...
  // Check URL parameter to show downsell directly
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const urlParams = new URLSearchParams(window.location.search)
      if (urlParams.get('show') === 'downsell') {
        ...
        {!showDownsell ? (
          ...
          <div className="p-6 md:p-10">
            ...
            <div className="mb-4 flex justify-center px-2">
              <div className="animate-pulse rounded-full bg-red-600 px-3 py-1.5 text-xs md:px-6 md:py-2 md:text-sm font-black text-white text-center">
                ⚡ LIMITED TIME - VIP UPGRADE ⚡
              </div>
            </div>

            {/* Countdown Timer */}
            <div className="mb-6 flex items-center justify-center gap-2 flex-wrap">
              <Clock className="h-5 w-5 md:h-6 md:w-6 text-red-500 animate-pulse" />
              <span className="text-lg md:text-2xl font-black text-red-500 text-center">
            ...
            <div className="mb-6 text-center px-2">
              <h2 className="mb-3 bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-400 bg-clip-text text-3xl font-black text-transparent md:text-6xl leading-tight">
                WAIT! DON'T LEAVE YET...
              </h2>
              <p className="mx-auto max-w-3xl text-lg font-bold text-yellow-400 md:text-3xl mb-3">
                You're One Of The 3% Who Get This VIP Offer
              </p>
              <p className="mx-auto max-w-2xl text-base text-gray-300 md:text-xl">
            ...
            {/* Social Proof */}
            <div className="mb-8 flex items-center justify-center gap-2 text-green-400 flex-wrap px-2">
              <Users className="h-4 w-4 md:h-5 md:w-5" />
              <span className="font-semibold text-sm md:text-base text-center">🔥 147 agents grabbed this in 24 hours</span>
            </div>
              ...
              <div>
                <div className="mb-6">
                  <div className="flex items-center gap-2 mb-3 flex-wrap">
                    ...
                    <h3 className="text-xl md:text-3xl font-black text-yellow-400">
                  ...
                  <div className="mb-6">
                    <div className="flex items-baseline gap-2 md:gap-3 mb-2 flex-wrap">
                      <span className="text-gray-500 line-through text-xl md:text-2xl">$497</span>
                      <span className="text-white text-4xl md:text-5xl font-black">$17</span>
                      <span className="text-green-400 font-bold text-lg md:text-xl">ONLY</span>
                    </div>
                  ...
                  >
                    ...
                    <div className="relative flex items-center justify-center gap-2 md:gap-3 rounded-2xl bg-gradient-to-r from-yellow-500 via-orange-500 to-yellow-600 px-4 py-4 md:px-8 md:py-6 text-lg md:text-2xl font-black text-black shadow-xl">
                      {isProcessing ? (
                        <>
                          <Loader className="h-5 w-5 md:h-7 md:w-7 animate-spin" />
                          <span>PROCESSING...</span>
                        </>
                      ) : (
                        <>
                          <Zap className="h-5 w-5 md:h-7 md:w-7" />
                          <span>ADD FOR $17</span>
                          <Zap className="h-5 w-5 md:h-7 md:w-7" />
                        </>
                      )}
                    </div>
            ...
            {/* Guarantee */}
            <div className="mb-6 rounded-2xl border-4 border-green-500 bg-gradient-to-br from-green-500/20 to-emerald-500/20 p-4 md:p-6">
              <div className="flex items-start gap-3 md:gap-4">
                <Shield className="h-8 w-8 md:h-12 md:w-12 flex-shrink-0 text-green-400" />
                <div>
                  <h4 className="text-lg md:text-2xl font-black text-green-400 mb-2">
          ...
          <div className="p-6 md:p-10">
            ...
            {/* Main Headline */}
            <div className="mb-6 text-center px-2">
              <h2 className="mb-3 bg-gradient-to-r from-blue-400 via-purple-500 to-blue-400 bg-clip-text text-3xl font-black text-transparent md:text-6xl leading-tight">
