...
import { Shield, Lock, CreditCard, CheckCircle, Star } from 'lucide-react';
            ...
            <form onSubmit={handleCheckout} className="space-y-6">
              ...
              >
                ...
                <div className="relative px-8 py-5 bg-gradient-to-r from-green-500 via-green-400 to-green-500 text-black rounded-2xl font-black text-xl uppercase tracking-wider transition-transform duration-300 active:scale-95 shadow-2xl flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed">
                  ...
                  <span>{isProcessing ? 'Processing...' : 'Complete Purchase $37'}</span>
                </div>
              </button>

              {/* Payment Methods */}
              <div className="text-center">
                <p className="text-xs text-gray-500 mb-3">We accept all major credit cards</p>
                <div className="flex items-center justify-center gap-3">
                  ...
                  <div className="px-3 py-1 bg-white rounded text-xs font-bold text-gray-800">AMEX</div>
                  <div className="px-3 py-1 bg-white rounded text-xs font-bold text-gray-800">DISCOVER</div>
                </div>
              </div>
