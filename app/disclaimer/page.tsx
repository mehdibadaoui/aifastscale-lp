...
export const metadata = {
  ...
  description: 'Disclaimer for Partnearn LLC - CloneYourself Video System. Important legal notices and disclaimers.',
}
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="rounded-xl border-2 border-purple-400 bg-purple-50 p-6 mb-4">
                ...
                <p className="mb-0 text-gray-700">
                  This product is for educational purposes only. Attorneys using AI-generated videos for marketing must ensure compliance with their state bar's Rules of Professional Conduct, including but not limited to rules governing attorney advertising, client solicitation, and required disclosures. Partnearn LLC does not provide legal advice regarding bar compliance. Users are solely responsible for ensuring their marketing materials comply with applicable bar rules and regulations.
                </p>
              </div>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 leading-relaxed text-gray-700">
                To the fullest extent permitted by applicable law, Partnearn LLC, its owners, employees, agents, and affiliates shall not be liable for:
              </p>
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-700">
