    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      <div className="max-w-4xl mx-auto px-4 md:px-6 py-12 md:py-20">
        ...
        <div className="bg-white rounded-3xl shadow-2xl border-2 border-gray-200 p-8 md:p-12">
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">Disclaimer</h1>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-blue-50 border-2 border-blue-400 rounded-xl p-6 mb-8">
              ...
              <p className="text-gray-700 mb-0">
                Please read this disclaimer carefully before using the AI FastScale website or purchasing the 7 Minute AgentClone Course. By accessing or using our service, you acknowledge that you have read, understood, and agree to be bound by this disclaimer.
              </p>
            </div>

            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">1. General Information</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                The information provided by AI FastScale ("we," "us," or "our") on our website and in the 7 Minute AgentClone Course is for general informational and educational purposes only. All information is provided in good faith; however, we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability, or completeness of any information.
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">2. No Guarantees of Results</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Any references to lead generation numbers, such as "5-15 leads per week" or "100+ monthly leads," are examples based on case studies and testimonials from specific users. These results are NOT typical and should NOT be interpreted as a guarantee or promise of your individual results.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                ...
                <li>Economic conditions and external factors beyond your control</li>
              </ul>
              <p className="text-gray-700 leading-relaxed">
                <strong>We do not guarantee that you will achieve any specific level of earnings, leads, sales, or success.</strong> Any earnings or results mentioned are not indicative of future performance.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">3. Educational Purpose Only</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                ...
                <li>A substitute for professional real estate training or licensing</li>
                <li>An automated or "done-for-you" service</li>
              </ul>
              <p className="text-gray-700 leading-relaxed">
                The course provides information and tools that require your own effort, time, and expertise to implement successfully.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">4. Testimonials and Case Studies</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                Testimonials and case studies presented on our website or in our marketing materials reflect the real experiences of actual users. However, these testimonials are not representative of all users' experiences and are not guarantees of future results.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
                Individual results vary significantly based on personal effort, market conditions, skill level, and other factors. The experiences shared by successful users should be considered exceptional rather than typical.
              </p>
              <p className="text-gray-700 leading-relaxed">
                <strong>Testimonial Disclaimer:</strong> Testimonials may have been edited for clarity, grammar, or length. Some testimonials may be compensated or incentivized. All testimonials are voluntary and reflect genuine user feedback.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">5. Third-Party Tools and Services</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                The course teaches you how to use various third-party AI tools and platforms (such as AI video generation services, social media platforms, etc.). We are NOT affiliated with, endorsed by, or sponsored by these third-party services unless explicitly stated.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                ...
                <li>We are not responsible for issues, downtime, or changes to third-party services</li>
              </ul>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">6. Real Estate Compliance</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                As a real estate professional, <strong>YOU are solely responsible</strong> for ensuring your use of AI-generated videos and marketing materials complies with:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
              ...
              <p className="text-gray-700 leading-relaxed">
                We are not responsible for any violations, fines, penalties, or legal issues resulting from your use of the course materials.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">7. AI-Generated Content Disclaimer</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                This course teaches you to create AI-generated talking videos. You acknowledge and understand that:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">8. Platform Policy Compliance</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                When using the strategies taught in this course on social media platforms (Facebook, Instagram, TikTok, YouTube, etc.), you are responsible for:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                ...
                <li>Accepting the risk of content removal, account suspension, or other enforcement actions</li>
              </ul>
              <p className="text-gray-700 leading-relaxed">
                Platform policies change frequently. What is permitted today may not be allowed tomorrow. We are not responsible for any account actions, content removal, or policy violations.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">9. Professional Advice Disclaimer</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                The information in this course is NOT a substitute for professional advice. For specific situations, you should consult:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                <li><strong>Legal advice:</strong> Consult an attorney for legal questions or compliance issues</li>
                <li><strong>Tax advice:</strong> Consult a CPA or tax professional for tax-related questions</li>
                <li><strong>Real estate broker:</strong> Consult your broker for brokerage-specific policies and requirements</li>
                <li><strong>Technical support:</strong> Consult the respective third-party service providers for technical issues with their tools</li>
              </ul>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">10. Website and Content Updates</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">11. External Links Disclaimer</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">12. Limitation of Liability</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">13. Changes to This Disclaimer</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-4">14. Contact Information</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <div className="bg-gradient-to-r from-blue-100 to-cyan-100 border-2 border-blue-400 rounded-xl p-6 mt-8">
              <p className="text-gray-900 font-bold mb-2">Final Note</p>
              <p className="text-gray-700 mb-0">
                By purchasing and using the 7 Minute AgentClone Course, you acknowledge that you have read, understood, and agree to this disclaimer. You accept full responsibility for your use of the course materials and any results or consequences thereof.
              </p>
            </div>
          </div>
        </div>
