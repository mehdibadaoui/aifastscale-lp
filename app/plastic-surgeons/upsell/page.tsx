...
const WHOP_UPSELL_LINK = 'https://whop.com/checkout/plan_c7mDkR3oBXE7n'
...
export default function PlasticSurgeonUpsellPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-[#1a1500] to-slate-950 flex items-center justify-center p-2 md:p-3">
      ...
      <div className="w-full max-w-md bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl md:rounded-2xl border border-amber-500/30 shadow-2xl shadow-amber-500/10 overflow-hidden">
        ...
        {/* Header - Timer */}
        <div className="bg-gradient-to-r from-amber-500 to-amber-500 px-3 md:px-4 py-2 md:py-2.5">
        ...
        <div className="p-3 md:p-4 max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-2 md:space-y-3">
            <a
              ...
              className="w-full bg-gradient-to-r from-amber-500 to-amber-500 text-white py-4 md:py-5 rounded-xl font-black text-base md:text-lg flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98] transition-transform shadow-lg shadow-amber-500/30"
            >
