...
export default function PlasticSurgeonLandingPage() {
  ...
  useEffect(() => {
    ...
    const calculateTimeLeft = () => {
      ...
      // If deadline passed, show zeros (no fake scarcity reset - Stripe compliant)
      if (diff <= 0) {
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-gray-800 text-lg sm:text-xl font-medium italic leading-relaxed mb-4">
                      ...
                      I spent $28,000 on marketing agencies over 8 months and got 4 consultations. This system cost me $47.81 and
      ...
      >
        <div className="w-full px-3 sm:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            {/* FTC Disclaimer after Case Study */}
            <p className="text-center text-gray-500 text-xs italic mt-6 max-w-2xl mx-auto px-4 py-3 border-l-2 border-amber-500/30 bg-white/5">
              *RESULTS NOT TYPICAL: This testimonial represents an individual&apos;s experience. Income and results vary significantly based on effort, market conditions, skills, and circumstances. We do not guarantee any specific results. <a href="/disclaimer" className="text-amber-500 hover:text-amber-400 underline">See full disclaimer</a>.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className={`space-y-4 ${visibleSections.has('reasons-why') ? 'animate-fade-in-up animation-delay-200' : ''}`}>
              {[
                ...
                },
                {
                  ...
                  desc: `At $47.81, I can reach ${memberStats.totalMembers.toLocaleString()}+ plastic surgeons. Even if only 10% create videos and 5% get results, that's hundreds of plastic surgeons getting new patients. That's hundreds of success stories. That's worth more to me than charging $497 to 50 plastic surgeons.`,
                },
                {
                  num: '4',
          ...
          <div className={`max-w-2xl mx-auto text-center ${visibleSections.has('final-cta') ? 'animate-fade-in-up' : ''}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 sm:mb-8">
              ...
              <div className="bg-amber-50 rounded-xl p-4 sm:p-5 text-left border-2 border-amber-500">
                ...
                <div className="mt-3 pt-3 border-t border-amber-200">
                  <p className="text-amber-700 font-bold text-xs">Cost: $47.81 one-time. Worst case: full refund, no questions asked</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-100 rounded-xl p-4 sm:p-5 mb-4 sm:mb-6 text-left border border-gray-200">
              ...
              <div className="space-y-2 text-gray-600 text-sm">
                <p>• If Option 2 gets you <span className="font-bold text-gray-900">just 1 new patient</span> in month 1... that's <span className="text-amber-600 font-bold">$2,000-5,000</span> from a $47.81 investment.</p>
                <p>• If you get <span className="font-bold text-gray-900">5 new patients</span> (average result)... that's <span className="text-amber-600 font-bold">$10,000-25,000</span> from $47.81.</p>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 sm:hidden bg-gradient-to-t from-black via-black/95 to-transparent pt-4 pb-safe">
        <div className="px-4 pb-4" style={{ paddingBottom: 'max(1rem, env(safe-area-inset-bottom))' }}>
          ...
          >
            ...
            <span className="text-amber-200 font-bold">$47.81</span>
            <ArrowRight className="w-5 h-5" />
          </a>
        </div>
      </div>
