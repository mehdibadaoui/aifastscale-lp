...
// Plastic Surgeon Pixel ID - PLACEHOLDER: User will provide actual ID
const PLASTIC_SURGEON_PIXEL_ID = 'PLACEHOLDER_PIXEL_ID'
...
export default function PlasticSurgeonLayout({
  ...
  return (
    <>
      ...
      {/* Meta Pixel for Plastic Surgeon LP - PLACEHOLDER */}
      {PLASTIC_SURGEON_PIXEL_ID !== 'PLACEHOLDER_PIXEL_ID' && (
        <>
          <Script
