...
export const BONUSES = [
  { id: 'bonus-1', name: '100 Viral Plastic Surgery Scripts', value: 397, icon: FileText, description: 'Copy-paste scripts that go viral on social media', category: 'Content', url: '/products/plastic-surgeon/bonuses/100-viral-video-scripts.html', image: '/images/plastic-surgeon/viral-scripts.webp' },
  { id: 'bonus-2', name: '365-Day Content Calendar', value: 297, icon: Calendar, description: 'Never run out of content ideas for a whole year', category: 'Planning', url: '/products/plastic-surgeon/bonuses/365-social-media-content.html', image: '/images/plastic-surgeon/social-templates.webp' },
  { id: 'bonus-3', name: 'High-Ticket Consultation Scripts', value: 497, icon: DollarSign, description: 'Close more $15K+ procedures with confidence', category: 'Sales', url: '/products/plastic-surgeon/bonuses/high-ticket-consultation-scripts.html', image: '/images/plastic-surgeon/consultation-scripts.webp' },
  { id: 'bonus-4', name: 'Before/After Content System', value: 397, icon: Rocket, description: 'Showcase transformations that convert', category: 'Content', url: '/products/plastic-surgeon/bonuses/before-after-content-system.html', image: '/images/plastic-surgeon/before-after.webp' },
  { id: 'bonus-5', name: 'Patient Coordinator Phone Scripts', value: 397, icon: Headphones, description: 'Convert more phone calls into booked consultations', category: 'Operations', url: '/products/plastic-surgeon/bonuses/patient-coordinator-scripts.html', image: '/images/plastic-surgeon/phone-scripts.webp' },
  { id: 'bonus-6', name: 'Patient Financing Scripts', value: 347, icon: FileText, description: 'Turn "I can\'t afford it" into "Yes, let\'s do it"', category: 'Sales', url: '/products/plastic-surgeon/bonuses/patient-financing-scripts.html', image: '/images/plastic-surgeon/financing-scripts.webp' },
  { id: 'bonus-7', name: 'Referral Machine System', value: 447, icon: Users, description: 'Turn happy patients into your best referral source', category: 'Marketing', url: '/products/plastic-surgeon/bonuses/patient-referral-machine.html', image: '/images/plastic-surgeon/referral-machine.webp' },
  { id: 'bonus-8', name: 'AI Content Generator (500+ Prompts)', value: 297, icon: Brain, description: 'Never write content from scratch again', category: 'AI Tools', url: '/products/plastic-surgeon/bonuses/ai-content-generator.html', image: '/images/plastic-surgeon/ai-generator.webp' },
  { id: 'bonus-9', name: '5-Star Review System', value: 397, icon: Star, description: 'Get 20+ Google reviews every month on autopilot', category: 'Reviews', url: '/products/plastic-surgeon/bonuses/5-star-review-system.html', image: '/images/plastic-surgeon/review-explosion.webp' },
  { id: 'bonus-10', name: 'VIP Concierge Patient System', value: 497, icon: Crown, description: 'Premium experience = premium prices', category: 'Operations', url: '/products/plastic-surgeon/bonuses/vip-concierge-system.html', image: '/images/plastic-surgeon/vip-concierge.webp' },
]
