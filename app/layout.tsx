...
export const metadata: Metadata = {
  ...
  description:
    'Turn a photo into a realistic talking AI video in 7 minutes. Get 5-15 leads this week, 100+ real buyer leads monthly. Built for real estate agents. No filming, no technical skills needed. $37 limited time offer.',
  keywords:
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                'Turn a photo into a realistic talking AI video in 7 minutes. Complete step by step blueprint with system prompts and workflows for real estate agents.',
